        ...
        <div class="insights-header">
          <h3>
            ...
            ${state.generatedCount > 0
              ? html`<span class="generated-count"
                  >✨ ${state.generatedCount} generated</span
                >`
              : ""}
          </h3>
                ...
                <div class="insight-category">
                  ...
                  <div class="insight-items">
                    ${insights.map(insight => {
                      const isGenerated = isGeneratedInsight(insight);
                      const isUsed = usedInsights.has(insight);
                      return html`
                        <span
                          class="insight-item ${isUsed
                            ? "used"
                            : ""} ${isGenerated ? "generated" : ""}"
                          title=${isGenerated
                            ? isUsed
                              ? "Generated by AI • Used in this conversation"
                              : "Generated by AI"
                            : isUsed
...
export const insightsStyles = css`
  ...
  .insight-item.generated {
    background: linear-gradient(135deg, #fff5e6 0%, #ffe8cc 100%);
    border-color: #ffb366;
    position: relative;
  }

  .insight-item.generated:hover {
    background: linear-gradient(135deg, #ffe8cc 0%, #ffd699 100%);
  }

  .insight-item.generated.used {
    background: linear-gradient(135deg, #e8f4fd 0%, #b3d7f2 100%);
    border-color: #0066cc;
  }

  .insight-item.generated.used:hover {
    background: linear-gradient(135deg, #d4edfc 0%, #8cc8ea 100%);
  }
