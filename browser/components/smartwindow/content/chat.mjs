...
Available tools:
- get_page_content: Fetches text for any tab in the Tab Context. Provide the url and optionally a mode ("viewport", "reader", or "full"). Prefer viewport for what the user currently sees. Use reader or full when the needed information is likely outside the viewport or broader context will help. Cache results per (url, mode) within the conversation; call again only if you need a different mode or the page content changed.
