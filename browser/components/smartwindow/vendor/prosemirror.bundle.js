...
var cr = (n, e) => {
  for (var t in e) Rs(n, t, { get: e[t], enumerable: !0 });
};
function P(n) {
  this.content = n;
}
P.prototype = {
  ...
  update: function (n, e, t) {
    var r = t && t != n ? this.remove(t) : this,
      ...
      s = r.content.slice();
    return (
      i == -1 ? s.push(t || n, e) : ((s[i + 1] = e), t && (s[i] = t)),
      new P(s)
    );
  },
  remove: function (n) {
    ...
    return (t.splice(e, 2), new P(t));
  },
  addToStart: function (n, e) {
    return new P([n, e].concat(this.remove(n).content));
  },
  addToEnd: function (n, e) {
    var t = this.remove(n).content.slice();
    return (t.push(n, e), new P(t));
  },
  addBefore: function (n, e, t) {
    var r = this.remove(e),
      i = r.content.slice(),
      s = r.find(n);
    return (i.splice(s == -1 ? i.length : s, 0, e, t), new P(i));
  },
  forEach: function (n) {
    for (var e = 0; e < this.content.length; e += 2)
  ...
  prepend: function (n) {
    return (
      (n = P.from(n)),
      n.size ? new P(n.content.concat(this.subtract(n).content)) : this
    );
  },
  append: function (n) {
    return (
      (n = P.from(n)),
      n.size ? new P(this.subtract(n).content.concat(n.content)) : this
    );
  },
  subtract: function (n) {
    var e = this;
...
function Sr(n, e, t, r) {
  for (let i = n.childCount, s = e.childCount; ; ) {
    ...
    if (o.isText && o.text != l.text) {
      ...
      for (
        ;
        c < f && o.text[o.text.length - c - 1] == l.text[l.text.length - c - 1];
    ...
    if (o.content.size || l.content.size) {
      let c = Sr(o.content, l.content, t - 1, r - 1);
      if (c) return c;
    }
    ((t -= a), (r -= a));
  }
...
var y = class n {
  ...
  findIndex(e) {
    ...
    for (let t = 0, r = 0; ; t++) {
      let i = this.child(t),
        s = r + i.nodeSize;
      if (s >= e) return s == e ? Mt(t + 1, s) : Mt(t, r);
      r = s;
    }
  }
  toString() {
...
function Ot(n, e) {
  ...
  if (t) {
    ...
    for (let r = 0; r < n.length; r++) if (!Ot(n[r], e[r])) return !1;
  } else {
    for (let r in n) if (!(r in e) || !Ot(n[r], e[r])) return !1;
...
var Me = class extends Error {},
  x = class n {
    ...
    insertAt(e, t) {
      let r = Mr(this.content, e + this.openStart, t);
      return r && new n(r, this.openStart, this.openEnd);
    }
    removeBetween(e, t) {
      return new n(
        kr(this.content, e + this.openStart, t + this.openStart),
        this.openStart,
        this.openEnd
      );
    }
...
function kr(n, e, t) {
  ...
  return n.replaceChild(r, s.copy(kr(s.content, e - i - 1, t - i - 1)));
}
function Mr(n, e, t, r) {
...
function Cr(n, e, t, r) {
  ...
  if (i == e.index(r) && r < n.depth - t.openStart) {
    ...
    if (!t.openStart && !t.openEnd && n.depth == r && e.depth == r) {
      ...
      let { start: o, end: l } = zs(t, n);
      return ke(s, Nr(n, o, l, e, r));
    }
  else return ke(s, Nt(n, e, r));
}
function Or(n, e) {
  if (!e.type.compatibleContent(n.type))
    throw new Me("Cannot join " + e.type.name + " onto " + n.type.name);
}
function en(n, e, t) {
  let r = n.node(t);
  return (Or(r, e.node(t)), r);
}
function Se(n, e) {
  let t = e.length - 1;
...
function et(n, e, t, r) {
  ...
  n &&
    ((s = n.index(t)),
    n.depth > t ? s++ : n.textOffset && (Se(n.nodeAfter, r), s++));
  for (let l = s; l < o; l++) Se(i.child(l), r);
  e && e.depth == t && e.textOffset && Se(e.nodeBefore, r);
}
function ke(n, e) {
  return (n.type.checkContent(e), n.copy(e));
}
function Nr(n, e, t, r, i) {
  let s = n.depth > i && en(n, e, i + 1),
    o = r.depth > i && en(t, r, i + 1),
    l = [];
  return (
    et(null, n, i, l),
    s && o && e.index(i) == t.index(i)
      ? (Or(s, o), Se(ke(s, Nr(n, e, t, r, i + 1)), l))
      : (s && Se(ke(s, Nt(n, e, i + 1)), l),
        et(e, t, i, l),
        o && Se(ke(o, Nt(t, r, i + 1)), l)),
    et(r, null, i, l),
    new y(l)
  );
}
function Nt(n, e, t) {
  let r = [];
  if ((et(null, n, t, r), n.depth > t)) {
    let i = en(n, e, t + 1);
    Se(ke(i, Nt(n, e, t + 1)), r);
  }
  return (et(e, null, t, r), new y(r));
}
function zs(n, e) {
...
var Dt = class n {
    ...
    static resolveCached(e, t) {
      ...
      else fr.set(e, (r = new tn()));
      let i = (r.elts[r.i] = n.resolve(e, t));
      return ((r.i = (r.i + 1) % Bs), i);
    }
  },
  tn = class {
    constructor() {
  ...
  _ = class n {
    ...
    hasMarkup(e, t, r) {
      return (
        this.type == e &&
        Ot(this.attrs, t || e.defaultAttrs || Fs) &&
        C.sameSet(this.marks, r || C.none)
      );
    }
    copy(e = null) {
    ...
    replace(e, t, r) {
      return Ps(this.resolve(e), this.resolve(t), r);
    }
    nodeAt(e) {
      for (let t = this; ; ) {
...
var rn = class n extends _ {
  ...
  toString() {
    return this.type.spec.toDebugString
      ...
      : Dr(this.marks, JSON.stringify(this.text));
  }
  get textContent() {
    return this.text;
  }
...
function $s(n) {
  ...
  function t(r) {
    ...
    let s = (e[r.join(",")] = new Ce(r.indexOf(n.length - 1) > -1));
...
function Rr(n, e) {
  let t = Object.create(null);
  if (e) for (let r in e) t[r] = new on(n, r, e[r]);
  return t;
}
var wt = class n {
  constructor(e, t, r) {
  ...
  create(e = null, t, r) {
    ...
    return new _(this, this.computeAttrs(e), y.from(t), C.setFrom(r));
  }
  createChecked(e = null, t, r) {
    return (
      (t = y.from(t)),
      this.checkContent(t),
      new _(this, this.computeAttrs(e), t, C.setFrom(r))
    );
  }
  createAndFill(e = null, t, r) {
    ...
    return s ? new _(this, e, t.append(s), C.setFrom(r)) : null;
  }
  validContent(e) {
...
var on = class {
    constructor(e, t, r) {
      ((this.hasDefault = Object.prototype.hasOwnProperty.call(r, "default")),
        ...
        (this.validate =
          typeof r.validate == "string" ? Hs(e, t, r.validate) : r.validate));
    }
    get isRequired() {
  ...
  nt = class n {
    ...
    create(e = null) {
      return !e && this.instance
        ? this.instance
        : new C(this, Ar(this.attrs, e));
    }
    static compile(e, t) {
      let r = Object.create(null),
        i = 0;
      return (e.forEach((s, o) => (r[s] = new n(s, i++, t, o))), r);
    }
    removeFromSet(e) {
  ...
  rt = class {
    constructor(e) {
      ...
      ((t.nodes = _t.from(e.nodes)),
        (t.marks = _t.from(e.marks || {})),
        (this.nodes = wt.compile(this.spec.nodes, this)),
        (this.marks = nt.compile(this.spec.marks, this)));
      let r = Object.create(null);
      for (let i in this.nodes) {
        ...
        let s = this.nodes[i],
          ...
          l = s.spec.marks;
        if (
          ((s.contentMatch = r[o] || (r[o] = Ce.parse(o, this.nodes))),
      ...
      ((this.nodeFromJSON = i => _.fromJSON(this, i)),
        (this.markFromJSON = i => C.fromJSON(this, i)),
    ...
    text(e, t) {
      ...
      return new rn(r, r.defaultAttrs, e, C.setFrom(t));
    }
    mark(e, t) {
...
var Ve = class n {
    ...
    parse(e, t = {}) {
      let r = new Tt(this, t, !1);
      return (r.addAll(e, C.none, t.from, t.to), r.finish());
    }
    parseSlice(e, t = {}) {
      let r = new Tt(this, t, !0);
      return (r.addAll(e, C.none, t.from, t.to), x.maxOpen(r.finish()));
    }
    matchTag(e, t, r) {
      for (
    ...
    static schemaRules(e) {
      ...
      for (let i in e.marks) {
        ...
        s &&
          s.forEach(o => {
            (r((o = mr(o))), o.mark || o.ignore || o.clearMark || (o.mark = i));
          });
      }
      for (let i in e.nodes) {
        ...
        s &&
          s.forEach(o => {
            (r((o = mr(o))), o.node || o.ignore || o.mark || (o.node = i));
          });
      }
      return t;
    }
    static fromSchema(e) {
      return (
        e.cached.domParser || (e.cached.domParser = new n(e, n.schemaRules(e)))
      );
    }
  },
  Pr = {
  ...
  Gs = { head: !0, noscript: !0, object: !0, script: !0, style: !0, title: !0 },
  zr = { ol: !0, ul: !0 },
  it = 1,
  ln = 2,
  tt = 4;
...
var ve = class {
    constructor(e, t, r, i, s, o) {
      ((this.type = e),
        ...
        (this.match = s || (o & tt ? null : e.contentMatch)));
    }
    findWrapping(e) {
      if (!this.match) {
        if (!this.type) return [];
    ...
    inlineContext(e) {
      return this.type
        ...
        : this.content.length
          ...
          : e.parentNode &&
            !Pr.hasOwnProperty(e.parentNode.nodeName.toLowerCase());
    }
  },
  Tt = class {
    constructor(e, t, r) {
      ...
      let i = t.topNode,
        s,
        o = pr(null, t.preserveWhitespace, 0) | (r ? tt : 0);
      (i
        ? (s = new ve(
            i.type,
            i.attrs,
    ...
    addTextNode(e, t) {
      let r = e.nodeValue,
        ...
        s =
          i.options & ln
            ? "full"
            : this.localPreserveWS || (i.options & it) > 0,
...
`
    ...
    addElement(e, t, r) {
      ...
      let o = e.nodeName.toLowerCase(),
        l;
      zr.hasOwnProperty(o) && this.parser.normalizeLists && Ys(e);
      let a =
        (this.options.ruleFromNode && this.options.ruleFromNode(e)) ||
        (l = this.parser.matchTag(e, this, r));
      e: if (a ? a.ignore : Gs.hasOwnProperty(o))
...
`),
    ...
    insertNode(e, t, r) {
      ...
      if (i) {
        ...
        for (let l of i.concat(e.marks))
          (s.type ? s.type.allowsMarkType(l.type) : gr(l.type, e.type)) &&
            (o = l.addToSet(o));
    ...
    enterInner(e, t, r, i = !1, s) {
      ...
      return (
        (r = r.filter(c =>
          (o.type ? o.type.allowsMarkType(c.type) : gr(c.type, e))
            ? ((a = c.addToSet(a)), !1)
            : !0
        )),
...
var fe = class n {
  ...
  serializeFragment(e, t = {}, r) {
    r || (r = Qt(t).createDocumentFragment());
    let i = r,
      s = [];
    return (
      e.forEach(o => {
  ...
  serializeMark(e, t, r = {}) {
    ...
    return i && Ct(Qt(r), i(e, t), null, e.attrs);
  }
...
function _s(n) {
  let e = xr.get(n);
  return (e === void 0 && xr.set(n, (e = Zs(n))), e);
}
function Zs(n) {
  let e = null;
  function t(r) {
...
function Ct(n, e, t, r) {
  ...
  if (c && typeof c == "object" && c.nodeType == null && !Array.isArray(c)) {
    ...
    for (let h in c)
      if (c[h] != null) {
        let u = h.indexOf(" ");
        u > 0
          ? a.setAttributeNS(h.slice(0, u), h.slice(u + 1), c[h])
          : h == "style" && a.style
            ? (a.style.cssText = c[h])
  ...
  for (let h = f; h < e.length; h++) {
    ...
    if (u === 0) {
      ...
      let { dom: d, contentDOM: p } = Ct(n, u, t, r);
...
var Lr = 1,
  ...
  Le = class {
    ...
    get deletedBefore() {
      return (this.delInfo & (Lr | Et)) > 0;
    }
    get deletedAfter() {
      return (this.delInfo & (Wr | Et)) > 0;
    }
    get deletedAcross() {
    ...
    _map(e, t, r) {
      ...
      for (let l = 0; l < this.ranges.length; l += 3) {
        ...
        let c = this.ranges[l + s],
          ...
          h = a + c;
        if (e <= h) {
          let u = c ? (e == a ? -1 : e == h ? 1 : t) : t,
            d = a + i + (u < 0 ? 0 : f);
          if (r) return d;
          let p = e == (t < 0 ? a : h) ? null : Qs(l / 3, e - a),
            m = e == a ? Wr : e == h ? Lr : Et;
          return ((t < 0 ? e != a : e != h) && (m |= Jr), new Le(d, m, p));
        }
        i += f - c;
      }
      return r ? e + i : new Le(e + i, 0, null);
    }
    touches(e, t) {
      let r = 0,
        i = Br(t),
...
var We = class n {
    ...
    slice(e = 0, t = this.maps.length) {
      return new n(this._maps, this.mirror, e, t);
    }
    appendMap(e, t) {
      (this.ownData ||
  ...
  T = class {
    ...
    static jsonID(e, t) {
      if (e in an) throw new RangeError("Duplicate use of step JSON ID " + e);
      return ((an[e] = t), (t.prototype.jsonID = e), t);
    }
  },
  A = class n {
    constructor(e, t) {
    ...
    static fromReplace(e, t, r, i) {
      try {
        ...
        if (s instanceof Me) return n.fail(s.message);
        throw s;
      }
    }
  };
function dn(n, e, t) {
  ...
  for (let i = 0; i < n.childCount; i++) {
    let s = n.child(i);
    (s.content.size && (s = s.copy(dn(s.content, e, s))),
      s.isInline && (s = e(s, t, i)),
      r.push(s));
  }
  return y.fromArray(r);
}
var Je = class n extends T {
  constructor(e, t, r) {
...
var he = class n extends T {
  ...
  apply(e) {
    let t = e.slice(this.from, this.to),
      r = new x(
        dn(t.content, i => i.mark(this.mark.removeFromSet(i.marks)), e),
        t.openStart,
        t.openEnd
      );
...
T.jsonID("removeMark", he);
var qe = class n extends T {
  constructor(e, t) {
...
T.jsonID("addNodeMark", qe);
var Oe = class n extends T {
  constructor(e, t) {
    (super(), (this.pos = e), (this.mark = t));
  }
  apply(e) {
...
T.jsonID("removeNodeMark", Oe);
var J = class n extends T {
  ...
  apply(e) {
    return this.structure && hn(e, this.from, this.to)
  ...
  map(e) {
    ...
    return t.deletedAcross && r.deletedAcross
      ? null
      : new n(t.pos, Math.max(t.pos, r.pos), this.slice, this.structure);
  }
  merge(e) {
...
var q = class n extends T {
  ...
  apply(e) {
    if (
      this.structure &&
      (hn(e, this.from, this.gapFrom) || hn(e, this.gapTo, this.to))
    )
  ...
  map(e) {
    ...
    return (t.deletedAcross && r.deletedAcross) || i < t.pos || s > r.pos
      ? null
      : new n(t.pos, r.pos, i, s, this.slice, this.insert, this.structure);
  }
  toJSON() {
    let e = {
  ...
  static fromJSON(e, t) {
    ...
    return new n(
      ...
      t.gapFrom,
      t.gapTo,
      x.fromJSON(e, t.slice),
      t.insert,
      !!t.structure
    );
  }
};
T.jsonID("replaceAround", q);
function hn(n, e, t) {
  let r = n.resolve(e),
    i = t - e,
    s = r.depth;
  ...
  (n.doc.nodesBetween(e, t, (a, c, f) => {
    ...
    if (!r.isInSet(h) && f.type.allowsMarkType(r.type)) {
      ...
      for (let m = 0; m < h.length; m++)
        h[m].isInSet(p) ||
          (o && o.to == u && o.mark.eq(h[m])
            ? (o.to = d)
            : i.push((o = new he(u, d, h[m]))));
      l && l.to == u ? (l.to = d) : s.push((l = new Je(u, d, r)));
    }
  }),
...
function pn(n, e, t, r = t.contentMatch, i = !0) {
  ...
  for (let a = 0; a < s.childCount; a++) {
    ...
    if (!h) o.push(new J(l, f, x.empty));
    else {
      r = h;
      for (let u = 0; u < c.marks.length; u++)
        t.allowsMarkType(c.marks[u].type) || n.step(new he(l, f, c.marks[u]));
      if (i && c.isText && t.whitespace != "pre") {
        ...
        for (; (u = d.exec(c.text)); )
          (p ||
            ...
            o.push(new J(l + u.index, l + u.index + u[0].length, p)));
      }
    }
    l = f;
  }
...
function ft(n) {
  ...
  for (let r = n.depth, i = 0, s = 0; ; --r) {
    ...
    if (r == 0 || o.type.spec.isolating || !ro(o, l, a)) break;
...
function io(n, e, t) {
  ...
  for (let p = s, m = !1; p > t; p--)
    m || r.index(p) > 0
      ? ((m = !0), (f = y.from(r.node(p).copy(f))), h++)
      : a--;
  let u = y.empty,
    d = 0;
  for (let p = s, m = !1; p > t; p--)
    m || i.after(p + 1) < i.end(p)
      ? ((m = !0), (u = y.from(i.node(p).copy(u))), d++)
      : c++;
  n.step(new q(a, c, o, l, new x(f.append(u), h, d), f.size - h, !0));
}
function mn(n, e, t = null, r = n) {
  let i = so(n, e),
    s = i && oo(r, e);
...
function ao(n, e, t, r, i) {
  ...
  n.doc.nodesBetween(e, t, (o, l) => {
    ...
    if (
      o.isTextblock &&
      !o.hasMarkup(r, a) &&
      co(n.doc, n.mapping.slice(s).map(l), r)
    ) {
      let c = null;
      if (r.schema.linebreakReplacement) {
        let d = r.whitespace == "pre",
          p = !!r.contentMatch.matchType(r.schema.linebreakReplacement);
        d && !p ? (c = !1) : !d && p && (c = !0);
      }
      (c === !1 && $r(n, o, l, s),
        pn(n, n.mapping.slice(s).map(l, 1), r, void 0, c === null));
      let f = n.mapping.slice(s),
        h = f.map(l, 1),
        u = f.map(l + o.nodeSize, 1);
      return (
        n.step(
          new q(
            h,
            ...
            h + 1,
            u - 1,
            new x(y.from(r.create(a, null, o.marks)), 0, 0),
            1,
            !0
          )
        ),
...
function $e(n, e, t = 1, r) {
  ...
  for (let c = i.depth - 1, f = t - 2; c > s; c--, f--) {
    ...
    let d = h.content.cutByIndex(u, h.childCount),
      p = r && r[f + 1];
    p && (d = d.replaceChild(0, p.type.create(p.attrs)));
    let m = (r && r[f]) || h;
    if (!h.canReplace(u + 1, h.childCount) || !m.type.validContent(d))
      return !1;
  }
...
function At(n, e) {
  let t = n.resolve(e),
    r = t.index();
  return Kr(t.nodeBefore, t.nodeAfter) && t.parent.canReplace(r, r + 1);
}
function uo(n, e) {
...
function Hr(n, e, t = -1) {
  ...
  for (let i = r.depth; ; i--) {
    ...
    if (
      ...
      s && !s.isTextblock && Kr(s, o) && r.node(i).canReplace(l, l + 1))
    )
      return e;
    if (i == 0) break;
...
function po(n, e, t) {
  ...
  if (r === !1) {
    ...
    $r(n, f.node(), f.before(), l);
  }
  o.inlineContent &&
    pn(n, e + t - 1, o, s.node().contentMatchAt(s.index()), r == null);
  let a = n.mapping.slice(l),
    c = a.map(e - t);
  if ((n.step(new J(c, a.map(e + t, -1), x.empty, !0)), r === !0)) {
    let f = n.doc.resolve(c);
    qr(n, f.node(), f.before(), n.steps.length);
  }
  return n;
}
function jr(n, e, t) {
...
function ht(n, e, t = e, r = x.empty) {
  if (e == t && !r.size) return null;
  let i = n.resolve(e),
    s = n.resolve(t);
  return Ur(i, s, r) ? new J(e, t, r) : new un(i, s, r).fit();
}
function Ur(n, e, t) {
  return (
    !t.openStart &&
...
var un = class {
  ...
  fit() {
    ...
    let a = new x(s, o, l);
    return e > -1
      ? new q(r.pos, e, this.$to.pos, this.$to.end(), a, t)
    ...
    for (let t = 1; t <= 2; t++)
      for (let r = t == 1 ? e : this.unplaced.openStart; r >= 0; r--) {
        let i,
          s = null;
        r
          ? ((s = cn(this.unplaced.content, r - 1).firstChild), (i = s.content))
        ...
        for (let l = this.depth; l >= 0; l--) {
          ...
          if (
            t == 1 &&
            (o
              ? c.matchType(o.type) || (h = c.fillBefore(y.from(o), !1))
  ...
  dropNode() {
    ...
    } else this.unplaced = new x(st(e, t, 1), t, r);
  }
  placeNodes({
    sliceDepth: e,
    frontierDepth: t,
    ...
    (p || (d = -1),
      (this.placed = ot(this.placed, t, y.from(f))),
    ...
    this.unplaced = p
      ? e == 0
        ? x.empty
        : new x(st(o.content, e - 1, 1), e - 1, d < 0 ? o.openEnd : e - 1)
      : new x(st(o.content, e, c), o.openStart, o.openEnd);
  }
  mustMoveInline() {
  ...
  close(e) {
    ...
    (t.fit.childCount && (this.placed = ot(this.placed, t.depth, t.fit)),
      (e = t.move));
  ...
  openFrontierNode(e, t = null, r) {
    ...
    ((i.match = i.match.matchType(e)),
      (this.placed = ot(this.placed, this.depth, y.from(e.create(t, r)))),
...
function st(n, e, t) {
  return e == 0
    ...
    : n.replaceChild(0, n.firstChild.copy(st(n.firstChild.content, e - 1, t)));
}
function ot(n, e, t) {
  return e == 0
    ? n.append(t)
    : n.replaceChild(
        n.childCount - 1,
        n.lastChild.copy(ot(n.lastChild.content, e - 1, t))
      );
}
function cn(n, e) {
...
function Gr(n, e, t) {
  ...
  return (
    e > 1 &&
      (r = r.replaceChild(
        0,
        Gr(r.firstChild, e - 1, r.childCount == 1 ? t - 1 : 0)
      )),
    e > 0 &&
...
function fn(n, e, t, r, i) {
  ...
  return l && !mo(t, s.content, o) ? l : null;
}
function mo(n, e, t) {
...
function yo(n, e, t, r) {
  ...
  let i = n.doc.resolve(e),
    s = n.doc.resolve(t);
  if (Ur(i, s, r)) return n.step(new J(e, t, r));
  let o = Xr(i, s);
  ...
  let a = o.indexOf(l),
    c = [],
    f = r.openStart;
  for (let u = r.content, d = 0; ; d++) {
    let p = u.firstChild;
    if ((c.push(p), d == r.openStart)) break;
    u = p.content;
  }
  for (let u = f - 1; u >= 0; u--) {
    let d = c[u],
      p = go(d.type);
    if (p && !d.sameMarkup(i.node(Math.abs(l) - 1))) f = u;
    else if (p || !d.type.isTextblock) break;
  }
  for (let u = r.openStart; u >= 0; u--) {
    let d = (u + f + 1) % (r.openStart + 1),
      p = c[d];
    if (p)
      for (let m = 0; m < o.length; m++) {
        ...
        let D = i.node(g - 1),
          N = i.index(g - 1);
        if (D.canReplaceWith(N, N, p.type, p.marks))
          return n.replace(
            i.before(g),
            b ? s.after(g) : t,
            new x(Yr(r.content, 0, r.openStart, d), d, r.openEnd)
          );
      }
  }
  ...
  for (
    let u = o.length - 1;
    u >= 0 && (n.replace(e, t, r), !(n.steps.length > h));
    u--
  ) {
    let d = o[u];
...
function Yr(n, e, t, r, i) {
  if (e < t) {
    let s = n.firstChild;
    n = n.replaceChild(0, s.copy(Yr(s.content, e + 1, t, r, s)));
  }
  if (e > r) {
...
Ne.prototype.name = "TransformError";
var ct = class {
  constructor(e) {
    ((this.doc = e),
      (this.steps = []),
  ...
  step(e) {
    ...
    if (t.failed) throw new Ne(t.failed);
    return this;
  }
  maybeStep(e) {
  ...
  setBlockType(e, t = e, r, i = null) {
    return (ao(this, e, t, r, i), this);
  }
  setNodeMarkup(e, t, r = null, i) {
    return (fo(this, e, t, r, i), this);
  }
  ...
  removeNodeMark(e, t) {
    ...
    if (t instanceof C) t.isInSet(r.marks) && this.step(new Oe(e, t));
    else {
      let i = r.marks,
        s,
        o = [];
      for (; (s = t.isInSet(i)); )
        (o.push(new Oe(e, s)), (i = s.removeFromSet(i)));
      for (let l = o.length - 1; l >= 0; l--) this.step(o[l]);
    }
    return this;
  }
  split(e, t = 1, r) {
    return (ho(this, e, t, r), this);
  }
  addMark(e, t, r) {
    return (to(this, e, t, r), this);
  }
  removeMark(e, t, r) {
    return (no(this, e, t, r), this);
  }
  clearIncompatible(e, t, r) {
    return (pn(this, e, t, r), this);
  }
};
var yn = Object.create(null),
  M = class {
    constructor(e, t, r) {
      ((this.$anchor = e),
        (this.$head = t),
        (this.ranges = r || [new He(e.min(t), e.max(t))]));
    }
    get anchor() {
    ...
    replace(e, t = x.empty) {
      ...
      for (let l = 0; l < o.length; l++) {
        let { $from: a, $to: c } = o[l],
          f = e.mapping.slice(s);
        (e.replaceRange(f.map(a.pos), f.map(c.pos), l ? x.empty : t),
          l == 0 && ei(e, s, (r ? r.isInline : i && i.isTextblock) ? -1 : 1));
      }
    }
    replaceWith(e, t) {
      ...
      for (let s = 0; s < i.length; s++) {
        ...
        s
          ? e.deleteRange(c, f)
          : (e.replaceRangeWith(c, f, t), ei(e, r, t.isInline ? -1 : 1));
      }
    }
    static findFrom(e, t, r = !1) {
      let i = e.parent.inlineContent
        ? new O(e)
        : Ke(e.node(0), e.parent, e.pos, e.index(), t, r);
      if (i) return i;
      for (let s = e.depth - 1; s >= 0; s--) {
        let o =
          t < 0
            ? Ke(e.node(0), e.node(s), e.before(s + 1), e.index(s), t, r)
            : Ke(e.node(0), e.node(s), e.after(s + 1), e.index(s) + 1, t, r);
        if (o) return o;
      }
      return null;
    }
...
var O = class n extends M {
  ...
  static between(e, t, r) {
    ...
    if (((!r || i) && (r = i >= 0 ? 1 : -1), !t.parent.inlineContent)) {
      let s = M.findFrom(t, r, !0) || M.findFrom(t, -r, !0);
      if (s) t = s.$head;
      else return M.near(t, r);
    }
    return (
      e.parent.inlineContent ||
        (i == 0
          ? (e = t)
          : ((e = (M.findFrom(e, -r, !0) || M.findFrom(e, r, !0)).$anchor),
            e.pos < t.pos != i < 0 && (e = t))),
      new n(e, t)
    );
  }
...
var bn = class n {
    ...
    map(e) {
      ...
      return t ? new Rt(r, r) : new n(r);
    }
    resolve(e) {
      let t = e.resolve(this.anchor),
        r = t.nodeAfter;
      return r && S.isSelectable(r) ? new S(t) : M.near(t);
    }
  },
  K = class n extends M {
    constructor(e) {
...
function Ke(n, e, t, r, i, s = !1) {
  ...
  for (let o = r - (i > 0 ? 0 : 1); i > 0 ? o < e.childCount : o >= 0; o += i) {
    ...
    if (l.isAtom) {
      ...
      let a = Ke(n, l, t + i, i < 0 ? l.childCount : 0, i, s);
      if (a) return a;
    }
    t += l.nodeSize * i;
  }
...
function ei(n, e, t) {
  ...
  if (r < e) return;
  let i = n.steps[r];
  if (!(i instanceof J || i instanceof q)) return;
  let s = n.mapping.maps[r],
    o;
  (s.forEach((l, a, c, f) => {
    o == null && (o = f);
  }),
    n.setSelection(M.near(n.doc.resolve(o), t)));
}
var ti = 1,
  It = 2,
  ni = 4,
  Sn = class extends ct {
    ...
    setSelection(e) {
      ...
      return (
        (this.curSelection = e),
        (this.curSelectionFor = this.steps.length),
        (this.updated = (this.updated | ti) & ~It),
    ...
    setStoredMarks(e) {
      return ((this.storedMarks = e), (this.updated |= It), this);
    }
    ensureMarks(e) {
      return (
    ...
    get storedMarksSet() {
      return (this.updated & It) > 0;
    }
    addStep(e, t) {
      (super.addStep(e, t),
        (this.updated = this.updated & ~It),
        (this.storedMarks = null));
    }
    setTime(e) {
    ...
    replaceSelectionWith(e, t = !0) {
      ...
      return (
        t &&
          (e = e.mark(
            this.storedMarks ||
              (r.empty ? r.$from.marks() : r.$from.marksAcross(r.$to) || C.none)
          )),
          ...
          : this.deleteSelection();
      {
        ...
        return (
          ...
          !this.selection.empty &&
            ...
            this.setSelection(M.near(this.selection.$to)),
          this
        );
      }
    }
...
var De = class {
    constructor(e, t, r) {
      ((this.name = e),
        (this.init = ri(t.init, r)),
        (this.apply = ri(t.apply, r)));
    }
  },
  ko = [
    new De("doc", {
    ...
    new De("selection", {
      init(n, e) {
        return n.selection || M.atStart(e.doc);
      },
      apply(n) {
        return n.selection;
      },
        ...
        t &&
          t.forEach(r => {
            ...
            (this.plugins.push(r),
              ...
              r.spec.state && this.fields.push(new De(r.key, r.spec.state, r)));
          }));
    }
  },
  kn = class n {
    ...
    static create(e) {
      let t = new ut(e.doc ? e.doc.type.schema : e.schema, e.plugins),
        r = new n(t);
    ...
    reconfigure(e) {
      let t = new ut(this.schema, e.plugins),
        r = t.fields,
        i = new n(t);
    ...
    static fromJSON(e, t, r) {
      ...
      let i = new ut(e.schema, e.plugins),
        s = new n(i);
      return (
        i.fields.forEach(o => {
          if (o.name == "doc") s.doc = _.fromJSON(e.schema, t.doc);
...
var re = class {
    constructor(e) {
      ((this.spec = e),
        (this.props = {}),
        e.props && ii(e.props, this, this.props),
        (this.key = e.key ? e.key.key : si("plugin")));
    }
    getState(e) {
      return e[this.key];
    }
...
var I = function (n) {
  ...
  wn = null,
  se = function (n, e, t) {
    let r = wn || (wn = document.createRange());
  ...
  Pe = function (n, e, t, r) {
    return t && (oi(n, e, t, r, -1) || oi(n, e, t, r, 1));
  },
  Co = /^(img|br|input|textarea|hr)$/i;
  ...
  for (var s; ; ) {
    ...
    if (e == (i < 0 ? 0 : j(n))) {
      ...
      if (o.nodeType == 1 && o.contentEditable == "false")
        if (
          !((s = o.pmViewDesc) === null || s === void 0) &&
          s.ignoreForSelection
        )
          e += i;
        else return !1;
      else ((n = o), (e = i < 0 ? j(n) : 0));
    } else return !1;
  }
}
function j(n) {
...
function Oo(n, e) {
  for (;;) {
    ...
    if (n.nodeType == 1 && e > 0) {
      ...
      ((n = n.childNodes[e - 1]), (e = j(n)));
    } else if (n.parentNode && !bt(n)) ((e = I(n)), (n = n.parentNode));
    else return null;
  }
}
function No(n, e) {
  for (;;) {
    ...
    } else if (n.parentNode && !bt(n)) ((e = I(n) + 1), (n = n.parentNode));
    else return null;
  }
}
function Do(n, e, t) {
  for (let r = e == 0, i = e == j(n); r || i; ) {
    if (n == t) return !0;
    let s = I(n);
...
var Kt = function (n) {
  return (
    n.focusNode && Pe(n.focusNode, n.focusOffset, n.anchorNode, n.anchorOffset)
  );
};
function we(n, e) {
...
var Q = typeof navigator < "u" ? navigator : null,
  li = typeof document < "u" ? document : null,
  xe = (Q && Q.userAgent) || "",
  Tn = /Edge\/(\d+)/.exec(xe),
  Li = /MSIE \d/.exec(xe),
  En = /Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(xe),
  $ = !!(Li || En || Tn),
  ge = Li ? document.documentMode : En ? +En[1] : Tn ? +Tn[1] : 0,
  U = !$ && /gecko\/(\d+)/i.test(xe);
U && +(/Firefox\/(\d+)/.exec(xe) || [0, 0])[1];
var An = !$ && /Chrome\/(\d+)/.exec(xe),
  B = !!An,
  Wi = An ? +An[1] : 0,
  v = !$ && !!Q && /Apple Computer/.test(Q.vendor),
  _e = v && (/Mobile\/\w+/.test(xe) || (!!Q && Q.maxTouchPoints > 2)),
  H = _e || (Q ? /Mac/.test(Q.platform) : !1),
  Eo = Q ? /Win/.test(Q.platform) : !1,
  oe = /Android \d/.test(xe),
  St = !!li && "webkitFontSmoothing" in li.documentElement.style,
  Ao = St
...
function ai(n, e, t) {
  ...
  for (let o = t || n.dom; o; ) {
    ...
    let l = o,
      ...
      h = 0;
    if (
      (e.top < c.top + ie(r, "top")
        ? (h = -(c.top - e.top + ie(i, "top")))
        : e.bottom > c.bottom - ie(r, "bottom") &&
          (h =
            e.bottom - e.top > c.bottom - c.top
              ? e.top + ie(i, "top") - c.top
              : e.bottom - c.bottom + ie(i, "bottom")),
      e.left < c.left + ie(r, "left")
        ? (f = -(c.left - e.left + ie(i, "left")))
        : e.right > c.right - ie(r, "right") &&
          (f = e.right - c.right + ie(i, "right")),
      f || h)
    )
      if (a) s.defaultView.scrollBy(f, h);
      else {
        let d = l.scrollLeft,
          p = l.scrollTop;
        (h && (l.scrollTop += h), f && (l.scrollLeft += f));
        let m = l.scrollLeft - d,
          g = l.scrollTop - p;
        e = {
          left: e.left - m,
          top: e.top - g,
...
function Po(n) {
  ...
  return { refDOM: r, refTop: i, stack: Ji(n.dom) };
}
function Ji(n) {
  let e = [],
    t = n.ownerDocument;
...
function zo({ refDOM: n, refTop: e, stack: t }) {
...
function $i(n, e) {
  ...
  for (let f = n.firstChild, h = 0; f; f = f.nextSibling, h++) {
    ...
    else if (f.nodeType == 3) u = se(f).getClientRects();
    else continue;
...
function Wo(n, e) {
  ...
  if (!o || !n.dom.contains(o.nodeType != 1 ? o.parentNode : o)) {
    ...
    if (!Hn(e, c) || ((o = Ki(n.dom, e, c)), !o)) return null;
  }
  if (v) for (let c = o; r && c; c = Xe(c)) c.draggable && (r = void 0);
  if (((o = vo(o, e)), r)) {
    if (
      U &&
      r.nodeType == 1 &&
...
function Hi(n, e, t) {
  let { node: r, offset: i, atom: s } = n.docView.domFromPos(e, t < 0 ? -1 : 1),
    o = St || U;
  if (r.nodeType == 3)
    if (o && (Jo.test(r.nodeValue) || (t < 0 ? !i : i == r.nodeValue.length))) {
      let a = de(se(r, i, i), t);
      if (U && i && /\s/.test(r.nodeValue[i - 1]) && i < r.nodeValue.length) {
        let c = de(se(r, i - 1, i - 1), -1);
        if (c.top == a.top) {
          let f = de(se(r, i, i + 1), -1);
          if (f.top != a.top) return dt(f, f.left < c.left);
        }
      }
      return a;
    } else {
        ...
        t < 0 && !i
          ...
          : t >= 0 && i == r.nodeValue.length
            ...
            : t < 0
              ? a--
              : c++,
        dt(de(se(r, a, c), f), f < 0)
      );
    }
  if (!n.state.doc.resolve(e - (s || 0)).parent.inlineContent) {
    if (s == null && i && (t < 0 || i == j(r))) {
    ...
    let c = a
      ? a.nodeType == 3
        ...
        : a.nodeType == 1
          ...
          : null
      : null;
    if (c) return dt(de(c, -1), !0);
  }
  return dt(de(r.nodeType == 3 ? se(r) : r, -t), t >= 0);
}
function dt(n, e) {
...
function Ko(n, e, t) {
  ...
  let i = r.parentOffset,
    ...
    l = n.domSelection();
  return l
    ? !$o.test(r.parent.textContent) || !l.modify
      ? t == "left" || t == "backward"
        ? s
        : o
      : ji(n, e, () => {
          ...
          let d = r.depth ? n.docView.domAfterPos(r.before()) : n.dom,
            { focusNode: p, focusOffset: m } = n.domSelectionRange(),
            g =
              (p && !d.contains(p.nodeType == 1 ? p : p.parentNode)) ||
              (a == p && c == m);
          try {
            (l.collapse(f, h),
...
function Ho(n, e, t) {
  return fi == e && hi == t
    ...
    : ((fi = e),
      (hi = t),
      (ui = t == "up" || t == "down" ? qo(n, e, t) : Ko(n, e, t)));
}
var G = 0,
  di = 1,
  Te = 2,
  ...
  ze = class {
    ...
    domFromPos(e, t) {
      ...
      for (
        let s;
        r && !(s = this.children[r - 1]).size && s instanceof Pt && s.side >= 0;
        r--
      );
      if (t <= 0) {
        let s,
        ...
        return s && t && o && !s.border && !s.domAtom
          ...
          : { node: this.contentDOM, offset: s ? I(s.dom) + 1 : 0 };
      } else {
        let s,
          o = !0;
        for (
        ...
        return s && o && !s.border && !s.domAtom
          ...
          : {
              ...
              offset: s ? I(s.dom) : this.contentDOM.childNodes.length,
            };
      }
    }
    parseRange(e, t, r = 0) {
...
`
            ...
            for (let m = d, g; m; m = m.parentNode) {
              if ((g = m.nextSibling)) {
                g.nodeName == "BR" &&
                  (l = a = { node: g.parentNode, offset: I(g) + 1 });
                break;
              }
              let b = m.pmViewDesc;
      ...
      if (
        ...
        let d = f.focusNode.childNodes[f.focusOffset];
        d && d.contentEditable == "false" && (i = !0);
      }
      if (
        !(i || (h && v)) &&
        Pe(l.node, l.offset, f.anchorNode, f.anchorOffset) &&
        Pe(a.node, a.offset, f.focusNode, f.focusOffset)
      )
        return;
      let u = !1;
      if ((c.extend || e == t) && !(h && U)) {
  ...
  Ze = class n extends ze {
    ...
    static create(e, t, r, i) {
      ...
      return (
        (!o || !o.dom) &&
          (o = fe.renderSpec(document, t.type.spec.toDOM(t, r), null, t.attrs)),
        new n(e, t, o.dom, o.contentDOM || o.dom, o)
      );
    }
    parseRule() {
    ...
    markDirty(e, t) {
      if ((super.markDirty(e, t), this.dirty != G)) {
        ...
        (r.dirty < this.dirty && (r.dirty = this.dirty), (this.dirty = G));
      }
    }
    slice(e, t, r) {
  ...
  ye = class n extends ze {
    ...
    static create(e, t, r, i, s, o) {
      ...
      if (t.isText) {
        ...
        f ||
          ({ dom: f, contentDOM: h } = fe.renderSpec(
            document,
            t.type.spec.toDOM(t),
            null,
            t.attrs
      ...
      return (
        (f = Yi(f, r, t)),
        c
          ? (a = new Rn(e, t, r, i, f, h || null, u, c, s, o + 1))
          : t.isText
            ? new zt(e, t, r, i, f, u, s)
            : new n(e, t, r, i, f, h || null, u, s, o + 1)
      );
    }
    parseRule() {
    ...
    updateChildren(e, t) {
      ...
      (Yo(
        ...
        (c, f, h) => {
          (c.spec.marks
            ...
            : c.type.side >= 0 &&
              !h &&
              a.syncToMarks(
                f == this.node.childCount ? C.none : this.node.child(f).marks,
                r,
                e
              ),
            a.placeWidget(c, e, i));
        ...
        (c, f, h, u) => {
          ...
          let d;
          (a.findNodeMatch(c, f, h, u) ||
            (l &&
              e.state.selection.from > i &&
              e.state.selection.to < i + c.nodeSize &&
              (d = a.findIndexWithChild(s.node)) > -1 &&
              a.updateNodeAt(c, f, h, d, e)) ||
            a.updateNextNode(c, f, h, e, u, i) ||
            a.addNode(c, f, h, e, i),
            (i += c.nodeSize));
        }
      ),
        ...
        (a.changed || this.dirty == Te) &&
          ...
          Ui(this.contentDOM, this.children, e),
          _e && Xo(this.dom)));
    }
    localCompositionInfo(e, t) {
      ...
      if (this.node.inlineContent) {
        let o = s.nodeValue,
          l = _o(this.node.content, o, r - t, i - t);
    ...
    protectLocalComposition(e, { node: t, pos: r, text: i }) {
      ...
      (e.input.compositionNodes.push(o),
        (this.children = Bn(this.children, r, r + i.length, e, o)));
    }
    update(e, t, r, i) {
      return this.dirty == ee || !e.sameMarkup(this.node)
        ? !1
    ...
    updateOuterDeco(e) {
      if (Ft(e, this.outerDeco)) return;
      let t = this.nodeDOM.nodeType != 1,
        r = this.dom;
      ((this.dom = Gi(
        this.dom,
        this.nodeDOM,
        Pn(this.outerDeco, this.node, t),
        Pn(e, this.node, t)
      )),
        this.dom != r &&
...
function pi(n, e, t, r, i) {
  Yi(r, e, n);
  let s = new ye(void 0, n, e, t, r, r, r, i, 0);
  return (s.contentDOM && s.updateChildren(i, 0), s);
}
var zt = class n extends ye {
...
function Ui(n, e, t) {
  ...
  for (let s = 0; s < e.length; s++) {
    ...
    if (o instanceof Ze) {
      ...
      (Ui(o.contentDOM, o.children, t), (r = a ? a.nextSibling : n.firstChild));
    }
  }
  for (; r; ) ((r = mi(r)), (i = !0));
...
pt.prototype = Object.create(null);
var Ee = [new pt()];
function Pn(n, e, t) {
  if (n.length == 0) return Ee;
  let r = t ? Ee[0] : new pt(),
    i = [r];
  for (let s = 0; s < n.length; s++) {
    let o = n[s].type.attrs;
    if (o) {
      o.nodeName && i.push((r = new pt(o.nodeName)));
      for (let l in o) {
        let a = o[l];
        a != null &&
          (t &&
            i.length == 1 &&
            i.push((r = new pt(e.isInline ? "span" : "div"))),
          l == "class"
...
function Yi(n, e, t) {
  return Gi(n, n, Ee, Pn(e, t, n.nodeType != 1));
}
function Ft(n, e) {
  if (n.length != e.length) return !1;
...
var zn = class {
  constructor(e, t, r) {
    ((this.lock = t),
      ...
      (this.changed = !1),
      (this.top = e),
      (this.preMatch = Uo(e.node.content, e)));
  }
  destroyBetween(e, t) {
    if (e != t) {
  ...
  syncToMarks(e, t, r) {
    ...
    for (; s < e.length; ) {
      ...
      if (l > -1)
        ...
        let a = Ze.create(this.top, e[s], t, r);
  ...
  updateNodeAt(e, t, r, i, s) {
    ...
    return (
      o.dirty == ee && o.dom == o.contentDOM && (o.dirty = Te),
      o.update(e, t, r, s)
  ...
  updateNextNode(e, t, r, i, s, o) {
    for (let l = this.index; l < this.top.children.length; l++) {
      ...
      if (a instanceof ye) {
        ...
        if (!u && (h = this.recreateWrapper(a, e, t, r, i, o)))
          return (
            this.destroyBetween(this.index, l),
            (this.top.children[this.index] = h),
            h.contentDOM &&
              ((h.dirty = Te), h.updateChildren(i, o + 1), (h.dirty = G)),
            (this.changed = !0),
            this.index++,
            !0
          );
  ...
  recreateWrapper(e, t, r, i, s, o) {
    if (
      ...
      return null;
    let l = ye.create(this.top, t, r, i, s, o);
    if (l.contentDOM) {
  ...
  addNode(e, t, r, i, s) {
    let o = ye.create(this.top, e, t, r, i, s);
  ...
  e: for (; i > 0; ) {
    ...
    for (;;)
      if (r) {
        ...
        if (c instanceof Ze) ((t = c), (r = c.children.length));
        else {
          ((l = c), r--);
          break;
        }
  ...
  for (let o = 0, l = 0; o < n.length; o++) {
    ...
    c >= t || f <= e
      ...
      : (c < e && s.push(a.slice(0, e - c, r)),
        i && (s.push(i), (i = void 0)),
        f > t && s.push(a.slice(t - c, a.size, r)));
  }
  return s;
}
function jn(n, e = null) {
  ...
  if (Kt(t)) {
    ...
    if (
      ...
      S.isSelectable(h) &&
      i.parent &&
      !(h.isInline && Do(t.focusNode, t.focusOffset, i.dom))
    ) {
      let u = i.posBefore;
      c = new S(o == u ? l : r.resolve(u));
    }
  } else {
    if (
      ...
      if (h < 0) return null;
      (([a, o] = u == n.state.selection.anchor ? [u, h] : [h, u]),
        (l = r.resolve(o)));
...
function Xi(n) {
  return n.editable
    ? n.hasFocus()
    : Zi(n) && document.activeElement && document.activeElement.contains(n.dom);
}
function le(n, e = !1) {
  ...
  if ((_i(n, t), !!Xi(n))) {
    if (!e && n.input.mouseDown && n.input.mouseDown.allowDefault && B) {
      ...
      if (
        r.anchorNode &&
        i.anchorNode &&
        Pe(r.anchorNode, r.anchorOffset, i.anchorNode, i.anchorOffset)
      ) {
    ...
    if ((n.domObserver.disconnectSelection(), n.cursorWrapper)) Qo(n);
    else {
      ...
      (gi &&
        !(t instanceof O) &&
        (t.$from.parent.inlineContent || (s = yi(n, t.from)),
        !t.empty && !t.$from.parent.inlineContent && (o = yi(n, t.to))),
        ...
        t.visible
          ...
          : (n.dom.classList.add("ProseMirror-hideselection"),
            "onselectionchange" in document && Zo(n)));
    }
...
function yi(n, e) {
  ...
  if (v && i && i.contentEditable == "false") return Cn(i);
  if (
...
function Cn(n) {
  return (
    ...
    v && n.draggable && ((n.draggable = !1), (n.wasDraggable = !0)),
    n
  );
}
function xi(n) {
  ...
  e.addEventListener(
    ...
    (n.input.hideSelectionGuard = () => {
      (t.anchorNode != r || t.anchorOffset != i) &&
        (e.removeEventListener("selectionchange", n.input.hideSelectionGuard),
        setTimeout(() => {
          (!Xi(n) || n.state.selection.visible) &&
            n.dom.classList.remove("ProseMirror-hideselection");
        }, 20));
    })
  );
...
function Qo(n) {
  ...
  let t = n.cursorWrapper.dom,
    r = t.nodeName == "IMG";
  (r ? e.collapse(t.parentNode, I(t) + 1) : e.collapse(t, 0),
    !r &&
...
function _i(n, e) {
  if (e instanceof S) {
    ...
    t != n.lastSelectedViewDesc &&
      (bi(n), t && t.selectNode(), (n.lastSelectedViewDesc = t));
  } else bi(n);
}
function bi(n) {
...
function Un(n, e, t, r) {
  return (
    n.someProp("createSelectionBetween", i => i(n, e, t)) || O.between(e, t, r)
  );
}
function Si(n) {
  return n.editable && !n.hasFocus() ? !1 : Zi(n);
}
function Zi(n) {
...
function ki(n, e, t) {
  ...
  if (r instanceof O)
    if (t.indexOf("s") > -1) {
      ...
      return pe(n, new O(r.$anchor, o));
    } else if (r.empty) {
      if (n.endOfTextblock(e > 0 ? "forward" : "backward")) {
        let i = Fn(n.state, e);
        return i && i instanceof S ? pe(n, i) : !1;
        ...
        return s.isAtom || ((o = n.docView.descAt(l)) && !o.contentDOM)
          ? S.isSelectable(s)
            ? pe(n, new S(e < 0 ? n.state.doc.resolve(i.pos - s.nodeSize) : i))
            : St
              ? pe(n, new O(n.state.doc.resolve(e < 0 ? l : l + s.nodeSize)))
              : !1
          : !1;
      }
    } else return !1;
    ...
    if (r instanceof S && r.node.isInline)
      return pe(n, new O(e > 0 ? r.$to : r.$from));
    {
      let i = Fn(n.state, e);
      return i ? pe(n, i) : !1;
    }
...
function tl(n) {
  ...
  let i,
    ...
    o = !1;
  for (
    U && t.nodeType == 1 && r < vt(t) && mt(t.childNodes[r], -1) && (o = !0);
    ;
    ...
    if (r > 0) {
      ...
      if (Qi(t)) break;
      {
        ...
        for (; l && mt(l, -1); )
          ((i = t.parentNode), (s = I(l)), (l = l.previousSibling));
        if (l) ((t = l), (r = vt(t)));
        else {
  ...
  for (;;)
    if (r < i) {
      ...
      if (Qi(t)) break;
      {
        let l = t.nextSibling;
        for (; l && mt(l, 1); )
          ((s = l.parentNode), (o = I(l) + 1), (l = l.nextSibling));
        if (l) ((t = l), (r = 0), (i = vt(t)));
        else {
          if (((t = t.parentNode), t == n.dom)) break;
          r = i = 0;
...
function il(n, e) {
  for (; n && !e && !bt(n); ) ((e = I(n)), (n = n.parentNode));
  for (; n && e; ) {
...
function vn(n, e, t) {
  if (e.nodeType != 3) {
    ...
    (o = rl(e, t))
      ? ((e = o), (t = 0))
      : (s = il(e, t)) && ((e = s), (t = s.nodeValue.length));
  }
...
function Mi(n, e) {
  ...
  if (!(B || Eo) && t.parent.inlineContent) {
...
function Ci(n, e, t) {
  ...
  if (!i.parent.inlineContent || n.endOfTextblock(e < 0 ? "up" : "down")) {
    let o = Fn(n.state, e);
    if (o && o instanceof S) return pe(n, o);
  }
  if (!i.parent.inlineContent) {
    let o = e < 0 ? i : s,
      l = r instanceof K ? M.near(o, e) : M.findFrom(o, e);
    return l ? pe(n, l) : !1;
  }
  return !1;
}
...
function sl(n) {
  if (!v || n.state.selection.$head.parentOffset > 0) return !1;
...
function ll(n, e) {
  let t = e.keyCode,
    r = ol(e);
  if (t == 8 || (H && t == 72 && r == "c")) return Oi(n, -1) || Ue(n, -1);
  if ((t == 46 && !e.shiftKey) || (H && t == 68 && r == "c"))
    return Oi(n, 1) || Ue(n, 1);
  if (t == 13 || t == 27) return !0;
  if (t == 37 || (H && t == 66 && r == "c")) {
    let i = t == 37 ? (Mi(n, n.state.selection.from) == "ltr" ? -1 : 1) : -1;
    return ki(n, i, r) || Ue(n, i);
  } else if (t == 39 || (H && t == 70 && r == "c")) {
    let i = t == 39 ? (Mi(n, n.state.selection.from) == "ltr" ? 1 : -1) : 1;
    return ki(n, i, r) || Ue(n, i);
  } else {
    if (t == 38 || (H && t == 80 && r == "c")) return Ci(n, -1, r) || Ue(n, -1);
    if (t == 40 || (H && t == 78 && r == "c"))
      return sl(n) || Ci(n, 1, r) || Ue(n, 1);
    if (r == (H ? "m" : "c") && (t == 66 || t == 73 || t == 89 || t == 90))
      return !0;
  }
  return !1;
}
function Gn(n, e) {
  ...
  let o = n.someProp("clipboardSerializer") || fe.fromSchema(n.state.schema),
    l = ss(),
  ...
  let c = a.firstChild,
    f,
    h = 0;
  for (; c && c.nodeType == 1 && (f = is[c.nodeName.toLowerCase()]); ) {
  ...
  let u =
    n.someProp("clipboardTextSerializer", d => d(e, n)) ||
...
function es(n, e, t, r, i) {
  ...
  if (a) {
    if (
      (n.someProp("transformPastedText", u => {
        e = u(e, s || r, n);
      }),
      s)
    )
...
`
    ...
    let h = n.someProp("clipboardTextParser", u => u(e, i, r, n));
    if (h) l = h;
    else {
      let u = i.marks(),
        { schema: d } = n.state,
  ...
  if (
    ...
    l = dl(Di(l, +f[1], +f[2]), f[4]);
  else if (((l = x.maxOpen(cl(l.content, i), !0)), l.openStart || l.openEnd)) {
    let h = 0,
      u = 0;
    for (
      let d = l.content.firstChild;
      h < l.openStart && !d.type.spec.isolating;
      h++, d = d.firstChild
    );
    for (
      let d = l.content.lastChild;
      u < l.openEnd && !d.type.spec.isolating;
      u++, d = d.lastChild
    );
    l = Di(l, h, u);
  }
    ...
    if (
      (n.forEach(l => {
        ...
        let a = i.findWrapping(l.type),
          c;
        if (!a) return (o = null);
        if ((c = o.length && s.length && ns(a, s, l, o[o.length - 1], 0)))
          o[o.length - 1] = c;
        else {
          o.length && (o[o.length - 1] = rs(o[o.length - 1], s.length));
          let f = ts(l, a);
...
function ns(n, e, t, r, i) {
  if (i < n.length && i < e.length && n[i] == e[i]) {
    let s = ns(n, e, t, r.lastChild, i + 1);
    ...
    if (
      ...
      return r.copy(r.content.append(y.from(ts(t, n, i + 1))));
  }
}
function rs(n, e) {
  if (e == 0) return n;
  let t = n.content.replaceChild(n.childCount - 1, rs(n.lastChild, e - 1)),
...
function Di(n, e, t) {
  return (
    e < n.openStart &&
      (n = new x(
        Vn(n.content, -1, e, n.openStart, 0, n.openEnd),
        e,
        n.openEnd
      )),
    t < n.openEnd &&
      (n = new x(Vn(n.content, 1, t, n.openEnd, 0, 0), n.openStart, t)),
    n
  );
}
var is = {
...
function hl(n) {
  ...
  let t = ss().createElement("div"),
    r = /<([a-z][^>\s]+)/i.exec(n),
    i;
  if (
    ((i = r && is[r[1].toLowerCase()]) &&
      (n =
        i.map(s => "<" + s + ">").join("") +
        n +
        i
  ...
  for (let e in V) {
    ...
    n.dom.addEventListener(
      ...
      (n.input.eventHandlers[e] = r => {
        yl(n, r) && !Yn(n, r) && (n.editable || !(r.type in L)) && t(n, r);
      }),
      pl[e] ? { passive: !0 } : void 0
    );
  }
  (v && n.dom.addEventListener("input", () => null), Wn(n));
}
function me(n, e) {
  ...
  n.someProp("handleDOMEvents", e => {
    for (let t in e)
      n.input.eventHandlers[t] ||
        n.dom.addEventListener(t, (n.input.eventHandlers[t] = r => Yn(n, r)));
  });
}
function Yn(n, e) {
...
function xl(n, e) {
  !Yn(n, e) && V[e.type] && (n.editable || !(e.type in L)) && V[e.type](n, e);
}
L.keydown = (n, e) => {
  let t = e;
  if (
    ...
    if (
      ...
      ((n.input.lastIOSEnter = r),
        (n.input.lastIOSEnterFallbackTimeout = setTimeout(() => {
          n.input.lastIOSEnter == r &&
            (n.someProp("handleKeyDown", i => i(n, we(13, "Enter"))),
            (n.input.lastIOSEnter = 0));
        }, 200)));
    } else
      n.someProp("handleKeyDown", r => r(n, t)) || ll(n, t)
        ? t.preventDefault()
        : me(n, "key");
};
L.keyup = (n, e) => {
...
L.keypress = (n, e) => {
  let t = e;
  if (as(n, t) || !t.charCode || (t.ctrlKey && !t.altKey) || (H && t.metaKey))
    return;
  ...
  if (!(r instanceof O) || !r.$from.sameParent(r.$to)) {
    ...
    (!/[\r\n]/.test(i) &&
      !n.someProp("handleTextInput", o => o(n, r.$from.pos, r.$to.pos, i, s)) &&
      n.dispatch(s()),
      t.preventDefault());
  }
};
...
function kl(n, e) {
  ...
  return i != null ? (Ye(n, S.create(n.state.doc, i), "pointer"), !0) : !1;
}
function Ml(n, e, t, r, i) {
  return (
    Xn(n, "handleClickOn", e, t, r) ||
...
function Cl(n, e, t, r) {
  return (
    Xn(n, "handleDoubleClickOn", e, t, r) ||
    n.someProp("handleDoubleClick", i => i(n, e, r))
  );
}
function Ol(n, e, t, r) {
  return (
    Xn(n, "handleTripleClickOn", e, t, r) ||
...
function Nl(n, e, t) {
  ...
  if (e == -1)
    return r.inlineContent
      ? (Ye(n, O.create(r, 0, r.content.size), "pointer"), !0)
      : !1;
  let i = r.resolve(e);
  for (let s = i.depth + 1; s > 0; s--) {
    let o = s > i.depth ? i.nodeAfter : i.node(s),
      l = i.before(s);
    if (o.inlineContent)
      Ye(n, O.create(r, l + 1, l + 1 + o.content.size), "pointer");
    else if (S.isSelectable(o)) Ye(n, S.create(r, l), "pointer");
    else continue;
    return !0;
  }
}
...
V.mousedown = (n, e) => {
  ...
  let o = n.posAtCoords(Ht(t));
  o &&
    (s == "singleClick"
      ? (n.input.mouseDown && n.input.mouseDown.done(),
        (n.input.mouseDown = new Jn(n, o, t, !!r)))
      : (s == "doubleClick" ? Cl : Ol)(n, o.pos, o.inside, t)
        ? t.preventDefault()
        : me(n, "pointer"));
};
var Jn = class {
  constructor(e, t, r, i) {
    ...
    (this.view.root.removeEventListener("mouseup", this.up),
      ...
      this.mightDrag &&
        ...
        this.view.domObserver.start()),
      this.delayedSelectionSync && setTimeout(() => le(this.view)),
      (this.view.input.mouseDown = null));
  }
  up(e) {
    if ((this.done(), !this.view.dom.contains(e.target))) return;
    let t = this.pos;
    (this.view.state.doc != this.startDoc && (t = this.view.posAtCoords(Ht(e))),
      this.updateAllowDefault(e),
      this.allowDefault || !t
        ? me(this.view, "pointer")
        : Ml(this.view, t.pos, t.inside, e, this.selectNode)
          ? e.preventDefault()
          : e.button == 0 &&
              (this.flushed ||
                (v && this.mightDrag && !this.mightDrag.node.isAtom) ||
                (B &&
            ...
            ? (Ye(
                this.view,
                M.near(this.view.state.doc.resolve(t.pos)),
                "pointer"
              ),
              e.preventDefault())
            : me(this.view, "pointer"));
...
V.touchstart = n => {
  ((n.input.lastTouch = Date.now()), _n(n), me(n, "pointer"));
};
V.touchmove = n => {
  ((n.input.lastTouch = Date.now()), me(n, "pointer"));
};
V.contextmenu = n => _n(n);
function as(n, e) {
  return n.composing
    ? !0
    : v && Math.abs(e.timeStamp - n.input.compositionEndedAt) < 500
...
function cs(n, e) {
  (clearTimeout(n.input.composingTimeout),
    e > -1 && (n.input.composingTimeout = setTimeout(() => Vt(n), e)));
}
function fs(n) {
  for (
    n.composing &&
    ((n.input.composing = !1), (n.input.compositionEndedAt = Tl()));
...
function wl(n) {
  ...
  let t = Oo(e.focusNode, e.focusOffset),
    r = No(e.focusNode, e.focusOffset);
  if (t && r && t != r) {
    let i = r.pmViewDesc,
...
function Vt(n, e = !1) {
  if (!(oe && n.domObserver.flushingSoon >= 0)) {
    if (
      (n.domObserver.forceFlush(), fs(n), e || (n.docView && n.docView.dirty))
    ) {
      let t = jn(n),
        r = n.state.selection;
      return (
...
var gt = ($ && ge < 15) || (_e && Ao < 604);
V.copy = L.cut = (n, e) => {
  let t = e,
    r = n.state.selection,
    i = t.type == "cut";
  if (r.empty) return;
  let s = gt ? null : t.clipboardData,
    o = r.content(),
    { dom: l, text: a } = Gn(n, o);
  (s
    ? (t.preventDefault(),
...
function Il(n, e) {
  ...
  setTimeout(() => {
    (n.focus(),
      ...
      t ? yt(n, r.value, null, i, e) : yt(n, r.textContent, r.innerHTML, i, e));
  }, 50);
}
function yt(n, e, t, r, i) {
  let s = es(n, e, t, r, n.state.selection.$from);
...
L.paste = (n, e) => {
  let t = e;
  if (n.composing && !oe) return;
  let r = gt ? null : t.clipboardData,
    i = n.input.shiftKey && n.input.lastKeyCode != 45;
  r && yt(n, hs(r), r.getData("text/html"), i, t)
    ? t.preventDefault()
    : Il(n, t);
};
var Lt = class {
...
V.dragstart = (n, e) => {
  ...
  let i = n.state.selection,
    s = i.empty ? null : n.posAtCoords(Ht(t)),
    o;
  if (!(s && s.pos >= i.from && s.pos <= (i instanceof S ? i.to - 1 : i.to))) {
    if (r && r.mightDrag) o = S.create(n.state.doc, r.mightDrag.pos);
    else if (t.target && t.target.nodeType == 1) {
      let h = n.docView.nearestDesc(t.target, !0);
      h &&
        h.node.type.spec.draggable &&
        h != n.docView &&
        (o = S.create(n.state.doc, h.posBefore));
    }
  }
  let l = (o || n.state.selection).content(),
    { dom: a, text: c, slice: f } = Gn(n, l);
  ((!t.dataTransfer.files.length || !B || Wi > 120) &&
    t.dataTransfer.clearData(),
    t.dataTransfer.setData(gt ? "Text" : "text/html", a.innerHTML),
    (t.dataTransfer.effectAllowed = "copyMove"),
    gt || t.dataTransfer.setData("text/plain", c),
    (n.dragging = new Lt(f, us(n, t), o)));
};
V.dragend = n => {
  let e = n.dragging;
  window.setTimeout(() => {
...
L.drop = (n, e) => {
  ...
  o
    ...
    : (o = es(
        n,
        hs(t.dataTransfer),
        gt ? null : t.dataTransfer.getData("text/html"),
        !1,
        s
      ));
  let l = !!(r && us(n, t));
  ...
  if (!o) return;
  t.preventDefault();
  let a = o ? gn(n.state.doc, s.pos, o) : s.pos;
  a == null && (a = s.pos);
  let c = n.state.tr;
  if (l) {
    let { node: p } = r;
  ...
  if (
    (h
      ? c.replaceRangeWith(f, f, o.content.firstChild)
      : c.replaceRange(f, f, o),
    c.doc.eq(u))
  )
    return;
  ...
  if (
    ...
    d.nodeAfter &&
    d.nodeAfter.sameMarkup(o.content.firstChild)
  )
    c.setSelection(new S(d));
  else {
    let p = c.mapping.map(a);
    (c.mapping.maps[c.mapping.maps.length - 1].forEach((m, g, b, D) => (p = D)),
      c.setSelection(Un(n, d, c.doc.resolve(p))));
  }
...
V.beforeinput = (n, e) => {
  if (B && oe && e.inputType == "deleteContentBackward") {
...
var Wt = class n {
    ...
    map(e, t, r, i) {
      ...
      return o ? null : new Y(s - r, s - r, this);
    }
    valid() {
      return !0;
    }
      ...
      return (
        ...
        (e instanceof n &&
          ((this.spec.key && this.spec.key == e.spec.key) ||
            (this.toDOM == e.toDOM && xt(this.spec, e.spec))))
      );
    }
    destroy(e) {
  ...
  Ae = class n {
    ...
    map(e, t, r, i) {
      ...
      return s >= o ? null : new Y(s, o, this);
    }
    valid(e, t) {
      return t.from < t.to;
    }
    eq(e) {
      return (
        this == e ||
        (e instanceof n && xt(this.attrs, e.attrs) && xt(this.spec, e.spec))
      );
    }
    static is(e) {
  ...
  Y = class n {
    ...
    static widget(e, t, r) {
      return new n(e, e, new Wt(t, r));
    }
    static inline(e, t, r, i) {
      return new n(e, t, new Ae(r, i));
    }
    static node(e, t, r, i) {
      return new n(e, t, new qn(r, i));
    }
    get spec() {
  ...
  F = class n {
    constructor(e, t) {
      ((this.local = e.length ? e : Ge), (this.children = t.length ? t : Ge));
    }
    static create(e, t) {
      return t.length ? qt(t, e, 0, Ie) : z;
    }
    find(e, t, r) {
      let i = [];
    ...
    map(e, t, r) {
      return this == z || e.maps.length == 0
        ? this
        : this.mapInner(e, t, 0, 0, r || Ie);
    }
    mapInner(e, t, r, i, s) {
      let o;
    ...
    addInner(e, t, r) {
      ...
      e.forEach((l, a) => {
        ...
        if ((f = ps(t, l, c))) {
          ...
          (i[s] == a
            ...
            : i.splice(s, 0, a, a + l.nodeSize, qt(f, l, c + 1, Ie)),
            (s += 3));
        }
      });
      let o = ds(s ? ms(t) : t, -r);
      ...
      return new n(
        o.length ? this.local.concat(o).sort(Re) : this.local,
        i || this.children
      );
    }
    remove(e) {
    ...
    localsInner(e) {
      if (this == z) return Ge;
      if (e.inlineContent || !this.local.some(Ae.is)) return this.local;
      let t = [];
      for (let r = 0; r < this.local.length; r++)
        this.local[r].type instanceof Ae || t.push(this.local[r]);
      return t;
    }
    forEachSet(e) {
      e(this);
...
var z = F.empty,
  Jt = class n {
    ...
    map(e, t) {
      let r = this.members.map(i => i.map(e, t, Ie));
      return n.from(r);
    }
    forChild(e, t) {
      if (t.isLeaf) return F.empty;
      let r = [];
      for (let i = 0; i < this.members.length; i++) {
        let s = this.members[i].forChild(e, t);
        s != z && (s instanceof n ? (r = r.concat(s.members)) : r.push(s));
      }
      return n.from(r);
    }
    eq(e) {
    ...
    static from(e) {
      switch (e.length) {
        ...
        default:
          return new n(
            e.every(t => t instanceof F)
              ? e
              : e.reduce((t, r) => t.concat(r instanceof F ? r : r.members), [])
          );
      }
    }
    forEachSet(e) {
  ...
  for (let c = 0; c < l.length; c += 3)
    if (l[c + 1] < 0) {
      ...
      if (g && m == h && m + g.nodeSize == d) {
        ...
        b != z
          ? ((l[c] = h), (l[c + 1] = d), (l[c + 2] = b))
          : ((l[c + 1] = -2), (a = !0));
      } else a = !0;
    }
  if (a) {
    let c = zl(l, n, e, t, i, s, o),
      f = qt(c, r, 0, o);
    e = f.local;
    for (let h = 0; h < l.length; h += 3)
      l[h + 1] < 0 && (l.splice(h, 3), (h -= 3));
    for (let h = 0, u = 0; h < f.children.length; h += 3) {
      let d = f.children[h];
      for (; u < l.length && l[u] < d; ) u += 3;
      l.splice(u, 0, f.children[h], f.children[h + 1], f.children[h + 2]);
    }
  }
  return new F(e.sort(Re), l);
}
function ds(n, e) {
  ...
  for (let r = 0; r < n.length; r++) {
    let i = n[r];
    t.push(new Y(i.from + e, i.to + e, i.type));
  }
  return t;
}
function zl(n, e, t, r, i, s, o) {
  function l(a, c) {
...
function qt(n, e, t, r) {
  ...
  e.forEach((l, a) => {
    ...
    if (c) {
      ...
      f != z && i.push(a, a + l.nodeSize, f);
    }
  });
  let o = ds(s ? ms(n) : n, -t).sort(Re);
  for (let l = 0; l < o.length; l++)
    o[l].type.valid(e, o[l]) ||
      (r.onRemove && r.onRemove(o[l].spec), o.splice(l--, 1));
  return o.length || i.length ? new F(o, i) : z;
}
function Re(n, e) {
      ...
      for (let i = t + 1; i < e.length; i++) {
        ...
        if (s.from == r.from) {
          s.to != r.to &&
            ...
            Ti(e, i + 1, s.copy(r.to, s.to)));
          continue;
        } else {
          s.from < r.to &&
            (e == n && (e = n.slice()),
            (e[t] = r.copy(r.from, s.from)),
            Ti(e, i, r.copy(s.from, r.to)));
          break;
        }
      }
  }
...
function Nn(n) {
  ...
  return (
    ...
    n.cursorWrapper && e.push(F.create(n.state.doc, [n.cursorWrapper.deco])),
    Jt.from(e)
  );
}
var Bl = {
  ...
  Kn = class {
    ...
    start() {
      (this.observer &&
        (this.observer.takeRecords(), this.observer.observe(this.view.dom, Bl)),
        this.onCharData &&
    ...
    onSelectionChange() {
      if (Si(this.view)) {
        if (this.suppressingSelectionUpdates) return le(this.view);
        if ($ && ge <= 11 && !this.view.state.selection.empty) {
    ...
    flush() {
      ...
      if (U && a.length) {
        ...
        if (f.length == 2) {
          ...
          for (let u of f) {
            let d = u.parentNode;
            d && d.nodeName == "LI" && (!h || Ll(e, h) != d) && u.remove();
          }
        }
      }
      let c = null;
      ...
      Kt(r) &&
      (c = jn(e)) &&
      c.eq(M.near(e.state.doc.resolve(0), 1))
        ? ((e.input.lastFocus = 0),
          le(e),
          this.currentSelection.set(r),
          e.scrollToSelection())
        : (s > -1 || i) &&
          (s > -1 && (e.docView.markDirty(s, o), vl(e)),
          this.handleDOMChange(s, o, l, a),
          e.docView && e.docView.dirty
            ? e.updateState(e.state)
            : this.currentSelection.eq(r) || le(e),
          this.currentSelection.set(r));
    }
    registerMutation(e, t) {
      ...
      if (e.type == "childList") {
        ...
        let i = e.previousSibling,
          s = e.nextSibling;
        if ($ && ge <= 11 && e.addedNodes.length)
          for (let f = 0; f < e.addedNodes.length; f++) {
            let { previousSibling: h, nextSibling: u } = e.addedNodes[f];
            ((!h || Array.prototype.indexOf.call(e.addedNodes, h) < 0) &&
              (i = h),
              (!u || Array.prototype.indexOf.call(e.addedNodes, u) < 0) &&
                (s = u));
          }
        let o = i && i.parentNode == e.target ? I(i) + 1 : 0,
          l = r.localPosFromDOM(e.target, o, -1),
          a = s && s.parentNode == e.target ? I(s) : e.target.childNodes.length,
...
function vl(n) {
  if (
    ...
    if (((n.requiresGeckoHackNode = U), Ai)) return;
    (console.warn(
...
function Ii(n, e) {
  ...
  return (
    Pe(o.node, o.offset, i, s) && ([t, r, i, s] = [i, s, t, r]),
...
function Wl(n, e, t) {
  ...
  if (
    (f &&
      ...
      Kt(a) || c.push({ node: a.focusNode, offset: a.focusOffset })),
  ...
  let h = n.state.doc,
    u = n.someProp("domParser") || Ve.fromSchema(n.state.schema),
    d = h.resolve(o),
    p = null,
    m = u.parse(r, {
      topNode: d.parent,
...
function Jl(n) {
  ...
  if (n.nodeName == "BR" && n.parentNode) {
    if (v && /^(ul|ol)$/i.test(n.parentNode.nodeName)) {
      let t = document.createElement("div");
      return (t.appendChild(document.createElement("li")), { skip: t });
    } else if (
      n.parentNode.lastChild == n ||
      (v && /^(tr|table)$/i.test(n.parentNode.nodeName))
    )
      return { ignore: !0 };
...
function $l(n, e, t, r, i) {
  ...
  if (((n.input.compositionPendingChanges = 0), e < 0)) {
    ...
    if (E && !n.state.selection.eq(E)) {
      if (
        ...
        n.someProp("handleKeyDown", Is => Is(n, we(13, "Enter")))
      )
        return;
      let W = n.state.tr.setSelection(E);
      (k == "pointer"
        ? W.setMeta("pointer", !0)
        : k == "key" && W.scrollIntoView(),
  ...
  (n.input.lastKeyCode === 8 && Date.now() - 100 < n.input.lastKeyCodeTime
    ? ((u = n.state.selection.to), (d = "end"))
    : ((u = n.state.selection.from), (d = "start")),
    (n.input.lastKeyCode = null));
  let p = jl(h.content, c.doc.content, c.from, u, d);
  if (
    (p && n.input.domChangeCount++,
    ((_e && n.input.lastIOSEnter > Date.now() - 225) || oe) &&
      i.some(k => k.nodeType == 1 && !ql.test(k.nodeName)) &&
      (!p || p.endA >= p.endB) &&
      n.someProp("handleKeyDown", k => k(n, we(13, "Enter"))))
  ) {
    n.input.lastIOSEnter = 0;
    return;
  }
  if (!p)
    if (
      ...
      if (c.sel) {
        let k = Ri(n, n.state.doc, c.sel);
        if (k && !k.eq(n.state.selection)) {
          let E = n.state.tr.setSelection(k);
  ...
  let m = c.doc.resolveNoCache(p.start - c.from),
    ...
    b = f.resolve(p.start),
    D = m.sameParent(g) && m.parent.inlineContent && b.end() >= p.endA;
  if (
    ((_e &&
      n.input.lastIOSEnter > Date.now() - 225 &&
      (!D || i.some(k => k.nodeName == "DIV" || k.nodeName == "P"))) ||
      (!D &&
  ...
  if (
    ...
    Hl(f, p.start, p.endA, m, g) &&
    n.someProp("handleKeyDown", k => k(n, we(8, "Backspace")))
  ) {
    oe && B && n.domObserver.suppressSelectionUpdates();
    return;
  }
  (B && p.endB == p.start && (n.input.lastChromeDelete = Date.now()),
    oe &&
      !D &&
      m.start() != g.start() &&
      g.parentOffset == 0 &&
        ...
        W &&
          !(
            (B &&
              ...
              (W.head == N || W.head == E.mapping.map(X) - 1)) ||
            ($ && W.empty && W.head == N)
          ) &&
          E.setSelection(W);
      }
  ...
  if (D)
    if (m.pos == g.pos) {
      $ &&
        ge <= 11 &&
        m.parentOffset == 0 &&
        (n.domObserver.suppressSelectionUpdates(), setTimeout(() => le(n), 20));
      let k = be(n.state.tr.delete(N, X)),
        E = f.resolve(p.start).marksAcross(f.resolve(p.endA));
      (E && k.ensureMarks(E), n.dispatch(k));
    } else if (
      p.endA == p.endB &&
      (kt = Kl(
      ...
      let k = be(n.state.tr);
      (kt.type == "add"
        ? k.addMark(N, X, kt.mark)
        : k.removeMark(N, X, kt.mark),
        n.dispatch(k));
    } else if (
      ...
      let k = m.parent.textBetween(m.parentOffset, g.parentOffset),
        E = () => be(n.state.tr.insertText(k, N, X));
      n.someProp("handleTextInput", W => W(n, N, X, k, E)) || n.dispatch(E());
    } else n.dispatch(be());
  else n.dispatch(be());
}
function Ri(n, e, t) {
  return Math.max(t.anchor, t.head) > e.content.size
    ? null
    : Un(n, e.resolve(t.anchor), e.resolve(t.head));
}
function Kl(n, e) {
...
function Hl(n, e, t, r, i) {
  if (t - e <= i.pos - r.pos || Dn(r, !0, !1) < i.pos) return !1;
  let s = n.resolve(e);
  ...
  if (s.parentOffset < s.parent.content.size || !s.parent.isTextblock)
    return !1;
  let o = n.resolve(Dn(s, !0, !0));
  return !o.parent.isTextblock || o.pos > t || Dn(o, !0, !1) < t
    ? !1
...
function jl(n, e, t, r, i) {
  ...
  if (o < s && n.size < e.size) {
    let a = r <= s && r >= o ? s - r : 0;
    ((s -= a),
      s && s < e.size && Pi(e.textBetween(s - 1, s + 1)) && (s += a ? 1 : -1),
      (l = s + (l - o)),
      (o = s));
  } else if (l < s) {
    let a = r <= s && r >= l ? s - r : 0;
    ((s -= a),
      s && s < n.size && Pi(n.textBetween(s - 1, s + 1)) && (s += a ? 1 : -1),
      (o = s + (o - l)),
      (l = s));
  }
...
var $t = class {
  constructor(e, t) {
    ((this._root = null),
      ...
      (this.docView = pi(this.state.doc, zi(this), Nn(this), this.dom, this)),
      (this.domObserver = new Kn(this, (r, i, s, o) => $l(this, r, i, s, o))),
  ...
  updateStateInner(e, t) {
    ...
    if (
      ...
      let d = vi(this);
      Gl(d, this.nodeViews) && ((this.nodeViews = d), (s = !0));
    }
    ((l || t.handleDOMEvents != this._props.handleDOMEvents) && Wn(this),
      (this.editable = Fi(this)),
      Bi(this));
    let a = Nn(this),
      c = zi(this),
    ...
    let u =
      f == "preserve" && o && this.dom.style.overflowAnchor == null && Po(this);
    if (o) {
      ...
      let d =
        ...
        !i.selection.empty &&
        !e.selection.empty &&
        Ul(i.selection, e.selection);
      if (h) {
        let p = B
          ? (this.trackWrites = this.domSelectionRange().focusNode)
          : null;
        (this.composing && (this.input.compositionNode = wl(this)),
          (s || !this.docView.update(e.doc, c, a, this)) &&
            (this.docView.updateOuterDeco(c),
            this.docView.destroy(),
            (this.docView = pi(e.doc, c, a, this.dom, this))),
          p && !this.trackWrites && (d = !0));
      }
      (d ||
      !(
        ...
        ? le(this, d)
        : (_i(this, e.selection), this.domObserver.setCurSelection()),
        this.domObserver.start());
    }
  ...
  updateDraggedNode(e, t) {
    ...
    this.dragging = new Lt(
      e.slice,
      e.move,
      i < 0 ? void 0 : S.create(this.state.doc, i)
    );
  }
  someProp(e, t) {
  ...
  destroy() {
    this.docView &&
      ...
      this.destroyPluginViews(),
      this.mounted
        ? (this.docView.update(this.state.doc, [], Nn(this), this),
  ...
  domSelectionRange() {
    ...
    return e
      ? (v &&
          ...
          wo(this.dom.ownerDocument) == this.dom &&
          Vl(this, e)) ||
          e
...
function zi(n) {
  ...
  return (
    ...
    [Y.node(0, n.state.doc.content.size, e)]
  );
}
function Bi(n) {
  if (n.markCursor) {
    ...
    ((e.className = "ProseMirror-separator"),
      ...
      (n.cursorWrapper = {
        dom: e,
        deco: Y.widget(n.state.selection.from, e, {
          raw: !0,
          marks: n.markCursor,
        }),
      }));
...
R.prototype.append = function (e) {
  return e.length
    ? ((e = R.from(e)),
      (!this.length && e) ||
        (e.length < jt && this.leafAppend(e)) ||
        (this.length < jt && e.leafPrepend(this)) ||
        this.appendInner(e))
    : this;
};
...
R.prototype.slice = function (e, t) {
  return (
    ...
    e >= t ? R.empty : this.sliceInner(Math.max(0, e), Math.min(this.length, t))
  );
};
...
R.from = function (e) {
  return e instanceof R ? e : e && e.length ? new gs(e) : R.empty;
};
var gs = (function (n) {
  function e(r) {
    ...
    return (
      ...
      (e.prototype.forEachInvertedInner = function (r, i, s, o) {
        ...
        if (
          ...
          (s < l &&
            this.left.forEachInvertedInner(r, Math.min(i, l), s, o) === !1)
        )
          return !1;
      }),
  ...
  Fe = class n {
    ...
    popEvent(e, t) {
      ...
      return (
        this.items.forEach(
          (h, u) => {
            if (!h.step) {
              (i || ((i = this.remapping(r, u + 1)), (s = i.maps.length)),
                s--,
                f.push(h));
              return;
            }
            if (i) {
              f.push(new te(h.map));
              let d = h.step.map(i.slice(s)),
                p;
              (d &&
                o.maybeStep(d).doc &&
                ((p = o.mapping.maps[o.mapping.maps.length - 1]),
                c.push(new te(p, void 0, void 0, c.length + f.length))),
                s--,
                p && i.appendMap(p, s));
    ...
    addTransform(e, t, r, i) {
      ...
      for (let f = 0; f < e.steps.length; f++) {
        let h = e.steps[f].invert(e.docs[f]),
          u = new te(e.mapping.maps[f], h, t),
          d;
        ((d = a && a.merge(u)) &&
          ((u = d), f ? s.pop() : (l = l.slice(0, l.length - 1))),
          s.push(u),
          t && (o++, (t = void 0)),
          i || (a = u));
      }
      let c = o - r.depth;
      return (c > Zl && ((l = _l(l, c)), (o -= c)), new n(l.append(s), o));
    }
    remapping(e, t) {
      let r = new We();
      return (
    ...
    addMaps(e) {
      return this.eventCount == 0
        ? this
        : new n(this.items.append(e.map(t => new te(t))), this.eventCount);
    }
    rebased(e, t) {
      ...
      this.items.forEach(u => {
        ...
        let p = s.maps[d];
        if (u.step) {
          let m = e.steps[d].invert(e.docs[d]),
            g = u.selection && u.selection.map(s.slice(a + 1, d));
          (g && l++, r.push(new te(p, m, g)));
        } else r.push(new te(p));
      }, i);
      let c = [];
      for (let u = t; u < o; u++) c.push(new te(s.maps[u]));
    ...
    compress(e = this.items.length) {
      ...
      return (
        ...
        new n(Qn.from(i.reverse()), s)
      );
    }
  };
Fe.empty = new Fe(Qn.empty, 0);
function _l(n, e) {
  let t;
  return (
    n.forEach((r, i) => {
...
function Ql(n, e, t, r) {
  ...
  t.getMeta(na) && (n = new ne(n.done, n.undone, null, 0, -1));
  let o = t.getMeta("appendedTransaction");
  if (t.steps.length == 0) return n;
  if (o && o.getMeta(Be))
    return o.getMeta(Be).redo
      ? new ne(
          n.done.addTransform(t, void 0, r, Ut(e)),
          n.undone,
          ys(t.mapping.maps),
          n.prevTime,
          n.prevComposition
      ...
      : new ne(
          n.done,
          n.undone.addTransform(t, void 0, r, Ut(e)),
          null,
          n.prevTime,
          n.prevComposition
        );
      ...
      a =
        ...
        (!o &&
          ...
          (n.prevTime < (t.time || 0) - r.newGroupDelay ||
            !ea(t, n.prevRanges))),
      c = o ? er(n.prevRanges, t.mapping) : ys(t.mapping.maps);
    return new ne(
      n.done.addTransform(t, a ? e.selection.getBookmark() : void 0, r, Ut(e)),
      Fe.empty,
      c,
      t.time,
      l ?? n.prevComposition
...
function ta(n, e, t) {
  ...
  let o = s.selection.resolve(s.transform.doc),
    ...
    a = new ne(t ? l : s.remaining, t ? s.remaining : l, null, 0, -1);
  return s.transform.setSelection(o).setMeta(Be, { redo: t, historyState: a });
}
var tr = !1,
  xs = null;
function Ut(n) {
...
var Be = new ue("history"),
  na = new ue("closeHistory");
function ra(n = {}) {
  return (
    ...
    new re({
      ...
      state: {
        init() {
          return new ne(Fe.empty, Fe.empty, null, 0, -1);
        },
        apply(e, t, r) {
          return Ql(t, r, e, n);
        },
      ...
      props: {
        handleDOMEvents: {
          beforeinput(e, t) {
            let r = t.inputType,
              i = r == "historyUndo" ? ia : r == "historyRedo" ? sa : null;
            return !i || !e.editable
              ? !1
              : (t.preventDefault(), i(e.state, e.dispatch));
          },
        },
      },
    })
...
var ae = {
  ...
  oa = typeof navigator < "u" && /Mac/.test(navigator.platform),
  la =
    typeof navigator < "u" &&
    /MSIE \d|Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(navigator.userAgent);
for (w = 0; w < 10; w++) ae[48 + w] = ae[96 + w] = String(w);
var w;
for (w = 1; w <= 24; w++) ae[w + 111] = "F" + w;
var w;
for (w = 65; w <= 90; w++)
  ((ae[w] = String.fromCharCode(w + 32)), (Xt[w] = String.fromCharCode(w)));
var w;
for (Yt in ae) Xt.hasOwnProperty(Yt) || (Xt[Yt] = ae[Yt]);
var Yt;
function bs(n) {
  var e =
      (oa && n.metaKey && n.shiftKey && !n.ctrlKey && !n.altKey) ||
      (la && n.shiftKey && n.key && n.key.length == 1) ||
      n.key == "Unidentified",
    t =
      (!e && n.key) ||
      (n.shiftKey ? Xt : ae)[n.keyCode] ||
      n.key ||
      "Unidentified";
  return (
    t == "Esc" && (t = "Escape"),
...
var aa =
  ...
  ca = typeof navigator < "u" && /Win/.test(navigator.platform);
function fa(n) {
  let e = n.split(/-(?!$)/),
    t = e[e.length - 1];
  t == "Space" && (t = " ");
  ...
  for (let l = 0; l < e.length - 1; l++) {
    ...
    else if (/^mod$/i.test(a)) aa ? (o = !0) : (i = !0);
...
function ua(n) {
  return new re({ props: { handleKeyDown: da(n) } });
}
function da(n) {
  let e = ha(n);
  return function (t, r) {
...
var ma = (n, e, t) => {
  ...
  let s = i.nodeBefore;
  if (Os(n, i, e, -1)) return !0;
  if (r.parent.content.size == 0 && (Qe(s, "end") || S.isSelectable(s)))
    for (let o = r.depth; ; o--) {
      let l = ht(n.doc, r.before(o), r.after(o), x.empty);
...
var ga = (n, e, t) => {
  ...
  return !o || !S.isSelectable(o)
    ...
    : (e &&
        e(
          n.tr
            .setSelection(S.create(n.doc, s.pos - o.nodeSize))
            .scrollIntoView()
        ),
      !0);
};
...
var xa = (n, e, t) => {
    ...
    let s = i.nodeAfter;
    if (Os(n, i, e, 1)) return !0;
    if (r.parent.content.size == 0 && (Qe(s, "start") || S.isSelectable(s))) {
      let o = ht(n.doc, r.before(), r.after(), x.empty);
  ...
  ba = (n, e, t) => {
    ...
    return !o || !S.isSelectable(o)
      ? !1
      : (e && e(n.tr.setSelection(S.create(n.doc, s.pos)).scrollIntoView()),
        !0);
  };
function Cs(n) {
  if (!n.parent.type.spec.isolating)
...
var ka = (n, e) => {
  ...
  Ma = (n, e) => {
    let t = n.selection,
      { $from: r, $to: i } = t;
    if (t instanceof K || r.parent.inlineContent || i.parent.inlineContent)
      return !1;
  ...
  Ca = (n, e) => {
    ...
    if (t.depth > 1 && t.after() != t.end(-1)) {
      let s = t.before();
      if ($e(n.doc, s)) return (e && e(n.tr.split(s).scrollIntoView()), !0);
    }
    let r = t.blockRange(),
      i = r && ft(r);
...
function Oa(n) {
  return (e, t) => {
    ...
    if (e.selection instanceof S && e.selection.node.isBlock)
      return !r.parentOffset || !$e(e.doc, r.pos)
        ? !1
    ...
    for (let d = r.depth; ; d--)
      if (r.node(d).isBlock) {
        ((a = r.end(d) == r.pos + (r.depth - d)),
          (c = r.start(d) == r.pos - (r.depth - d)),
          (l = ir(r.node(d - 1).contentMatchAt(r.indexAfter(d - 1)))));
    ...
    let f = e.tr;
    (e.selection instanceof O || e.selection instanceof K) &&
      f.deleteSelection();
    let h = f.mapping.map(r.pos),
      u = $e(f.doc, h, s.length, s);
    if (
      (u || ((s[0] = l ? { type: l } : null), (u = $e(f.doc, h, s.length, s))),
      !u)
    )
      return !1;
    if ((f.split(h, s.length, s), !a && c && r.node(o).type != l)) {
      let d = f.mapping.map(r.before(o)),
        p = f.doc.resolve(d);
      l &&
        r.node(o - 1).canReplaceWith(p.index(), p.index() + 1, l) &&
        f.setNodeMarkup(f.mapping.map(r.before(o)), l);
    }
    return (t && t(f.scrollIntoView()), !0);
  };
}
var Na = Oa();
var Da = (n, e) => (e && e(n.tr.setSelection(new K(n.doc))), !0);
function wa(n, e, t) {
  let r = e.nodeBefore,
    i = e.nodeAfter,
    s = e.index();
  return !r || !i || !r.type.compatibleContent(i.type)
    ...
    : !r.content.size && e.parent.canReplace(s - 1, s)
      ...
      : !e.parent.canReplace(s, s + 1) || !(i.isTextblock || At(n.doc, e.pos))
        ? !1
...
function Os(n, e, t, r) {
  ...
  if (
    ...
    if (t) {
      ...
      p = y.from(i.copy(p));
      let m = n.tr.step(
          new q(e.pos - 1, d, e.pos, d, new x(p, 1, 0), o.length, !0)
        ),
        g = m.doc.resolve(d + 2 * o.length);
      (g.nodeAfter &&
        g.nodeAfter.type == i.type &&
        At(m.doc, g.pos) &&
        m.join(g.pos),
        t(m.scrollIntoView()));
    }
  ...
  let f = s.type.spec.isolating || (r > 0 && a) ? null : M.findFrom(e, 1),
    h = f && f.$from.blockRange(f.$to),
    u = h && ft(h);
  if (u != null && u >= e.depth)
    return (t && t(n.tr.lift(h, u).scrollIntoView()), !0);
...
function Ns(n) {
  return function (e, t) {
    ...
    return i.node(s).isTextblock
      ? (t &&
          t(e.tr.setSelection(O.create(e.doc, n < 0 ? i.start(s) : i.end(s)))),
        !0)
      : !1;
  };
}
...
function Pa(n) {
  ...
  for (let t = 0; t < n.length; t++) {
    let { $from: r, $to: i } = n[t];
    (r.doc.nodesBetween(r.pos, i.pos, (s, o) => {
      if (
        s.isAtom &&
        s.content.size &&
        s.isInline &&
        ...
        return (
          o + 1 > r.pos && e.push(new He(r, r.doc.resolve(o + 1))),
          (r = r.doc.resolve(o + 1 + s.content.size)),
          !1
        );
    }),
      r.pos < i.pos && e.push(new He(r, i)));
  }
  return e;
}
function za(n, e = null, t) {
  let r = (t && t.removeWhenPresent) !== !1,
    i = (t && t.enterInlineAtoms) !== !1,
    s = !(t && t.includeWhitespace);
  return function (o, l) {
    let { empty: a, $cursor: c, ranges: f } = o.selection;
    if ((a && !c) || !Ra(o.doc, f, n, i)) return !1;
    if (l)
      if (c)
        n.isInSet(o.storedMarks || c.marks())
          ? l(o.tr.removeStoredMark(n))
          : l(o.tr.addStoredMark(n.create(e)));
      else {
        let h,
          u = o.tr;
        (i || (f = Pa(f)),
          r
            ? (h = !f.some(d => o.doc.rangeHasMark(d.$from.pos, d.$to.pos, n)))
            : (h = !f.every(d => {
                let p = !1;
                return (
                  u.doc.nodesBetween(d.$from.pos, d.$to.pos, (m, g, b) => {
                    if (p) return !1;
                    p =
                      !n.isInSet(m.marks) &&
                      !!b &&
                      b.type.allowsMarkType(n) &&
                      !(
                        m.isText &&
                        /^\s*$/.test(
                          m.textBetween(
                            Math.max(0, d.$from.pos - g),
        ...
        for (let d = 0; d < f.length; d++) {
          let { $from: p, $to: m } = f[d];
          if (!h) u.removeMark(p.pos, m.pos, n);
          else {
            let g = p.pos,
              b = m.pos,
              D = p.nodeAfter,
              N = m.nodeBefore,
              X = s && D && D.isText ? /^\s*/.exec(D.text)[0].length : 0,
              be = s && N && N.isText ? /\s*$/.exec(N.text)[0].length : 0;
            (g + X < b && ((g += X), (b -= be)), u.addMark(g, b, n.create(e)));
          }
        }
        l(u.scrollIntoView());
      }
...
var rr = sr(ks, ma, ga),
  ...
  Ds = {
    "Ctrl-h": ce.Backspace,
    "Alt-Backspace": ce["Mod-Backspace"],
    "Ctrl-d": ce.Delete,
    "Ctrl-Alt-Backspace": ce["Mod-Delete"],
    "Alt-Delete": ce["Mod-Delete"],
    "Alt-d": ce["Mod-Delete"],
    "Ctrl-a": Ta,
    "Ctrl-e": Ea,
  };
for (let n in ce) Ds[n] = ce[n];
var Ba =
    typeof navigator < "u"
...
var va = ["p", 0],
  ...
  Ua = new rt({ nodes: qa, marks: ja });
var As = {};
cr(As, {
  addMentionNodes: () => Es,
  addTagNodes: () => Ts,
  mentionNodeSpec: () => ar,
  suggestionsPlugin: () => ws,
  tagNodeSpec: () => lr,
  triggerCharacter: () => or,
});
function or(n, e = !1) {
  return t => {
    let r = new RegExp(`\\s${n}$`),
      i = e
        ? new RegExp(`${n}.*?(?=\\s${n}|$)`, "g")
        : new RegExp(`(?:^)?${n}[^\\s${n}]*`, "g"),
      s = t.before(),
      o = t.end(),
      l = t.doc.textBetween(s, o, "\0", "\0"),
      a;
    for (; (a = i.exec(l)); ) {
      let c = a.input.slice(Math.max(0, a.index - 1), a.index);
      if (!/^[\s\0]?$/.test(c)) continue;
      let f = a.index + t.start(),
        h = f + a[0].length;
      if (
        (e && r.test(l.slice(h - 1, h + 1)) && ((a[0] += " "), h++),
        f < t.pos && h >= t.pos)
      )
        return { range: { from: f, to: h }, text: a[0] };
    }
  };
}
function ws({
  ...
  onExit: i = () => !1,
  onKeyDown: s = () => !1,
  escapeOnSelectionChange: o = !0,
  escapeKeys: l = ["Escape", "ArrowRight", "ArrowLeft"],
  debug: a = !1,
}) {
  return new re({
    key: new ue("suggestions"),
    view() {
      return {
        update: (c, f) => {
          let h = this.key.getState(f),
            u = this.key.getState(c.state),
            d = h.active && u.active && h.range.from !== u.range.from,
            p = !h.active && u.active,
            m = h.active && !u.active,
            g = !p && !m && h.text !== u.text;
          ((m || d) && i({ view: c, range: h.range, text: h.text }),
            g && !d && r({ view: c, range: u.range, text: u.text }),
    ...
    state: {
      init() {
        return { active: !1, range: {}, text: null };
      },
      apply(c, f) {
        let h = c.getMeta(this.key);
        if (h) return h;
        let { selection: u } = c,
          d = { ...f };
        if (o && !c.docChanged && c.selectionSet) d.active = !1;
        else if (u.from === u.to) {
          (u.from < f.range.from || u.from > f.range.to) && (d.active = !1);
          let p = u.$from,
            m = n(p);
          m
            ? ((d.active = !0), (d.range = m.range), (d.text = m.text))
            : (d.active = !1);
        } else d.active = !1;
    ...
    props: {
      handleKeyDown(c, f) {
        let { active: h } = this.getState(c.state);
        if (!h) return !1;
        if (l.includes(f.key)) {
          let u = c.state.tr.setMeta(this.key, {
            active: !1,
            range: {},
            text: null,
          });
          return (c.dispatch(u), !1);
        }
        return s({ view: c, event: f });
      },
      decorations(c) {
        let { active: f, range: h } = this.getState(c);
        return f
          ? F.create(c.doc, [
              Y.inline(h.from, h.to, {
                nodeName: "span",
                class: e,
                style: a
...
var lr = {
  ...
  selectable: !1,
  atom: !0,
  toDOM: n => ["span", { class: "tag", "data-tag-id": n.attrs.id }, n.attrs.id],
  parseDOM: [
    {
      tag: "span[data-tag-id]",
      getAttrs: n => ({ id: n.getAttribute("data-tag-id") }),
    },
  ],
};
function Ts(n) {
  return n.append({ tag: lr });
}
var ar = {
  attrs: { type: {}, id: {}, label: {} },
  group: "inline",
  ...
  toDOM: n => [
    ...
    {
      class: "mention",
      "data-mention-type": n.attrs.type,
  ...
  parseDOM: [
    {
      ...
      getAttrs: n => {
        let e = n.getAttribute("data-mention-type"),
          t = n.getAttribute("data-mention-id"),
          r = n.innerText;
        return { type: e, id: t, label: r };
      },
    },
  ],
};
function Es(n) {
  return n.append({ mention: ar });
}
export {
  Ve as DOMParser,
  fe as DOMSerializer,
  ...
  rt as Schema,
  O as TextSelection,
  Es as addMentionNodes,
  Ts as addTagNodes,
  Fa as baseKeymap,
  Ua as basicSchema,
  ra as history,
  ua as keymap,
  ar as mentionNodeSpec,
  Ia as setBlockType,
  As as suggestions,
  ws as suggestionsPlugin,
  lr as tagNodeSpec,
  za as toggleMark,
  _r as transform,
  or as triggerCharacter,
  Aa as wrapIn,
};
