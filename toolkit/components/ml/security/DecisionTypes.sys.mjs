 ...
 * @property {string} code - Machine-readable denial code (see DenialCodes)
 * @property {string} reason - Human-readable explanation of the denial
...
// Standard human-readable reason phrases for denial codes.
 ...
 * @param {string} reason - Human-readable reason (typically from ReasonPhrases)
